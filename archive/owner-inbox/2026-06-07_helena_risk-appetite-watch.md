...
asOf: 2026-06-07T05:59:56.064Z
decision-required: false
---

# Helena — risk-appetite watch, 2026-06-07
...
**Headline:** 14 appetite lines · 9 measured · 0 unmeasured (substrate gap) · 0 open breaches (0 tier-1, 0 tier-2) · 32 days since RAS approval.

## Appetite-line states

| Line | Category | Tier | RAS § | Status | Note |
|---|---|---|---|---|---|
| LCR buffer | liquidity | tier-1 | RAS §B3 | green | LCR T+30 = 500.4% (HQLA R50,043,950, net outflows R10,000,000). RAS §B3 thresholds: green ≥120% / amber 110-120% / red <110% / critical <105%. Substrate gaps: 1 class(es). |
...
| CET1 buffer over PA min | capital | tier-1 | RAS §B3 | green | Live capital position derived from CapitalEvent events: capital R300 000 000, headroom R263 325 000, CET1 ratio 369.23%. TICR = R36 675 000. RWA: live positions (3 trade events; D-RWA-LIVE-POSITIONS-PROJECTION-V1). Status: green. |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CboPWYRQVLdgoSEnq8UxJ"})._
