...
asOf: 2026-05-08T05:53:56.297Z
decision-required: false
---

# Iris — POPIA controls snapshot, 2026-05-08
...
**Headline:** 17 POPIA / PAIA obligations indexed (1 PARTIAL / deferred) · 0 DSAR received / 0 closed in the last 7 days · 0 `PersonalInformationCompromiseSuspected` events · 0 s.22 notifications dispatched.

## POPIA / PAIA obligations slice

| Obligation | Citation | Owner | Status |
|---|---|---|---|
| ORG-PR(IV)-01 | POPIA 4/2013 s.11 | Iris | **IN FORCE** |
| ORG-PR(IV)-02 | POPIA s.13 | Iris | **IN FORCE** |
| ORG-PR(IV)-03 | POPIA s.14 | Iris + Owen | **IN FORCE** |
| ORG-PR(IV)-04 | POPIA s.15 | Iris | **IN FORCE** |
| ORG-PR(IV)-05 | POPIA s.18 | Iris + Niko | **IN FORCE** |
| ORG-PR(IV)-06 | POPIA ss.19–22 | Iris + Senna | **IN FORCE** |
| ORG-PR(IV)-07 | POPIA s.22 | Iris (with Senna) | **IN FORCE** |
| ORG-PR(IV)-08 | POPIA s.23 | Iris | **IN FORCE** |
| ORG-PR(IV)-09 | POPIA s.24 | Iris | **IN FORCE** |
| ORG-PR(IV)-10 | POPIA s.71 | Iris (with Helena) | **IN FORCE** |
| ORG-PR(IV)-11 | POPIA s.34 | Iris | **IN FORCE** |
| ORG-PR(IV)-12 | POPIA s.35 | Iris | **IN FORCE** |
| ORG-PR(IV)-13 | POPIA ss.55–56 + POPIA Reg. 4 | Iris (designation lodgment **deferred** — Round 1 E1) | PARTIAL |
| ORG-PR(IV)-14 | POPIA s.57 | Iris | **IN FORCE** |
| ORG-PR(IV)-15 | POPIA s.72 | Iris (with Devon) | **IN FORCE** |
| ORG-PR(IV)-16 | PAIA 2/2000 s.51 | Iris + Owen | **IN FORCE** |
| ORG-PR(IV)-17 | PAIA | Iris (case-managed) | **IN FORCE** |
