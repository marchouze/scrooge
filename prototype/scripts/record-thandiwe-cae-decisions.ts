...
recordDecision({
  ...
  category: "governance",
  recommendation: "Vera's overnight recon of 2026-05-18: 7 pipelines pass, 0 fail, 0 warn. Control environment is clean at this stage of the build phase.",
  rationale: "Third-line opinion issued under CAE mandate per Thandiwe operating spec §9. No escalation required. Next opinion at Q3 2026 or on material finding.",
  sourceDocHashes: [],
