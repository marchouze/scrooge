...
asOf: 2026-06-08T03:28:05.220Z
decision-required: false
---

# Anya — projection drift, 2026-06-08
...
| Owner Inbox deliverables | 656 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-08T03:27:38.578Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cbq5jCXqxvMqusZfy1Am5"})._
