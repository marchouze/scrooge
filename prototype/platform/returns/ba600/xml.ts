// platform/returns/ba600/xml.ts
//
// M3 Slice 5 — BA 600 XML serialiser entry point.
//
// Re-exports the XML adapter and render utilities from the reporting package
// as the canonical BA 600 XML surface. This thin wrapper keeps the
// `returns/ba600/` API self-contained (callers can import from here rather
...
export {
  ...
  BA_600_XSD_URI,
  ba600ToXmlPayload,
} from "../../reporting/ba-600-xml-adapter";
...
export type { Ba600Output } from "../../reporting/ba-600-op-risk";
