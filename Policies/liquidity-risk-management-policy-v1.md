...
citations:
  ...
  - PA D1/2022 (LCR — Scope of Application and Calculation; current instrument)
  - PA D1/2019 (LCR public-disclosure standard)
  - PA D6/2015 (LCR — superseded reference, retained for lineage)
...
| 3 | PA Directive 1 of 2022 — *LCR: Scope of Application and Matters Related to Calculation and Disclosure* (effective 11 February 2022; replaces Directive 11 of 2014) `[citation: TBC — precise § references inside D1/2022 confirmed against `Regulations/Banks/source-docs/banks-d1-2022-structured.json`; §1.2, §2.3, §2.5, §3.1, §3.2, §4.1.1–§4.1.6, §4.1.2.1–§4.1.2.12 cited inline below]` | **Current** SA-specific LCR scope-of-application instrument: HQLA-stock objective, consolidation scope and methodology, currency/Rand reporting, intragroup elimination, 75% group-basis inflow cap, monthly consolidated calculation, quarterly daily-average public disclosure, and non-compliance written-notification. Operationalises Reg 26's LCR provisions. | `ORG-PR-LCR-001` … `ORG-PR-LCR-010` |
| 3a | PA Directive 1 of 2019 — LCR public-disclosure standard `[citation: TBC — D1/2019 disclosure-template references; incorporated by reference via D1/2022 §4.1.1 and §4.1.4]` | The LCR public-disclosure requirements (simple averages of daily observations over the previous quarter) that D1/2022 directs the bank to comply with | `ORG-PR-LCR-002`, `ORG-PR-LCR-009` |
| 3b | PA Directive 6 of 2015 — Revised LCR (proposed Government Notice) — **superseded reference, retained for lineage** `[citation: TBC — precise § references inside D6/2015; survey URL: https://www.resbank.co.za/content/dam/sarb/publications/prudential-authority/pa-deposit-takers/banks-directives/2015/6685/02-D6---Directive-revised-LCR-proposed-Government-Notice-Annexure-A.pdf]` | The earlier (2015) SA LCR calibration instrument; the live LCR scope-of-application obligations now derive from D1/2022 (rank 3), which the bank treats as the governing instrument. D6/2015 is retained only for historical lineage. | `ORG-PR-36` (legacy) |
...
| 7 | BCBS *Basel III: The Liquidity Coverage Ratio and liquidity risk monitoring tools* (BCBS D238, January 2013) | LCR standard and the monitoring-tools framework; the bank's LCR computation follows this standard | `ORG-PR-06` |
| 8 | BCBS *Basel III: The Net Stable Funding Ratio* (BCBS D295, October 2014) | NSFR standard; the bank's NSFR computation follows this standard | `ORG-PR-07` |
...
**PA minimum requirement:** LCR ≥ 100% at all times per Reg 26(2), read with the current LCR scope-of-application instrument PA Directive 1 of 2022 (`ORG-PR-LCR-001`). PA D6/2015 (`ORG-PR-36`) is the superseded earlier calibration reference, retained for lineage only.
...
**Activated obligation status:** `ORG-PR-06` (BCBS D238 / BA 300 — Liquidity Risk, incl. LCR) and the PA Directive 1 of 2022 cluster `ORG-PR-LCR-001` … `ORG-PR-LCR-010` (HQLA maintenance for the 30-day stress; D1/2019 disclosure; consolidation scope, summation and HQLA cap, intragroup elimination, 75% group-basis inflow cap, Rand solo+consolidated reporting, monthly consolidated calculation, quarterly daily-average public disclosure, non-compliance written-notification) — **IN FORCE** from commencement of trading. The D1/2022 cluster is discharged across §2.2 (HQLA), §2.3 (computation and disclosure basis), §2.6 (consolidation rules), and §9.2 (non-compliance notification) per the §10 closure table.

**Consolidated obligation:** `ORG-BNK-ILAAP-CONS` (consolidated ILAAP submission) — the bank entity submits a consolidated ILAAP to PA that aggregates liquidity across `Hoz Bank Limited` + `Hoz Securities Limited`. Both the solo and consolidated LCR are produced by the BA 300 liquidity-risk projection substrate, subject to the D1/2022 consolidation rules specified in §2.6.
...
| Level 2B | A+/A/A-/BBB- rated eligible corporate bonds; qualifying equities; qualifying RMBS; **the SARB Restricted Committed Liquidity Facility (RCLF)** (per §2.2.1) | 25–50% haircut (asset-specific) | 15% of total HQLA stock post-cap |

HQLA eligibility is assessed on the basis of the BCBS D238 §§ 49–66 criteria `[citation: TBC — precise paragraph indices]` and Reg 26(7) `[citation: TBC]`. The BA 300 LCR projection substrate (under `prototype/platform/reporting/`; Bea's Reporting Capability Slice 3 — the module filename is re-numbered to the canonical BA 300 under the reporting-code track of `D-BA-RETURN-NUMBERING-EXCEL-CANONICAL`) implements the closed-form cap arithmetic per BCBS D238 § 47.
...
#### 2.2.1 SARB Restricted Committed Liquidity Facility (RCLF) — Level 2B treatment

The SARB **Restricted Committed Liquidity Facility (RCLF)** is recognised as **Level 2B HQLA**, per PA Directive 1 of 2023 §2.3.6.1 (`ORG-PR-NSFR-009`), which directs that the RCLF be reported in accordance with **Regulation 26(12)(b)(iii)(D)** of the Regulations Relating to Banks as Level 2B high-quality liquid assets `[citation: TBC — D1/2023 §2.3.6.1 confirmed against `Regulations/Banks/source-docs/banks-d1-2023-structured.json`; Reg 26(12)(b)(iii)(D) sub-clause text pending Imani (Legal-as-code engineer, engineering) + external counsel ratification at the licence-application gate]`.

The RCLF is a material HQLA source in the South African context, where the supply of Level-1 South African Government Bonds (SAGB) eligible as HQLA is structurally constrained relative to system liquidity needs; the committed facility from the SARB is the PA-recognised mechanism for banks to meet the LCR without an unattainable stock of Level-1 securities. Treatment in this policy:

- The drawable, committed, and unencumbered portion of the RCLF counts as Level 2B HQLA, subject to the asset-specific haircut and the 15% Level 2B cap (and the combined 40% Level 2 cap) in the §2.2 table.
- Eitan (Treasurer, governance) maintains the RCLF facility documentation, monitors the committed and drawn amounts, and confirms the unencumbered drawable balance at each LCR computation.
- Any RCLF utilisation is reported to ALCO; a material change in the committed amount is a funding-profile event under §3.5.

### 2.3 LCR computation frequency, reporting, and public-disclosure basis
...
**Public LCR disclosure basis (`ORG-PR-LCR-002`, `ORG-PR-LCR-009`).** The bank's **public** LCR disclosure is presented as **simple averages of daily observations over the previous quarter** — that is, the average is calculated over a period of, typically, 90 daily observations — and is published **quarterly**, in accordance with PA Directive 1 of 2022 §3.2 and §4.1.4, which incorporate the LCR disclosure requirements of **PA Directive 1 of 2019** by reference (D1/2022 §4.1.1). This daily-average disclosure basis is distinct from the internal daily computation above: the internal LCR is a point-in-time daily projection for ALCO governance; the public Pillar 3 disclosure aggregates those daily observations into quarterly simple averages per the D1/2019 template. The Pillar 3 Disclosure Policy LCR table is anchored on this D1/2022 §3.2 / D1/2019 simple-average-of-daily-observations basis; Bea (Accounting & financial reporting engineer, engineering) compiles the quarterly disclosure for publication under the Pillar 3 Disclosure Policy. `[citation: TBC — D1/2019 disclosure-template line references pending ratification; D1/2022 §3.2/§4.1.4 confirmed against `Regulations/Banks/source-docs/banks-d1-2022-structured.json`.]`
...
### 2.6 Consolidated LCR — D1/2022 consolidation rules

The bank computes the LCR on both a **solo (entity)** and a **consolidated** basis (§1.2). The consolidated computation follows the consolidation rules of PA Directive 1 of 2022 §4.1.2 (`ORG-PR-LCR-003`, `ORG-PR-LCR-004`, `ORG-PR-LCR-005`), as follows `[citation: TBC — D1/2022 §4.1.2.1–§4.1.2.12 confirmed against `Regulations/Banks/source-docs/banks-d1-2022-structured.json`; Regulations Relating to Banks Reg 36 (consolidated-supervision inclusion) and Reg 26(12) sub-clause indices pending Imani (Legal-as-code engineer, engineering) + external counsel ratification at the licence-application gate]`:

1. **Inclusion scope (`ORG-PR-LCR-003`, D1/2022 §4.1.2.1–§4.1.2.4).** Only **banking and/or deposit-taking entities** are included in the consolidated LCR. Branches are consolidated in accordance with the home/host jurisdiction parameters of D1/2022 §2.5. All banking/deposit-taking entities operating in a jurisdiction where LCR compliance is a regulatory requirement are included; entities in jurisdictions where the LCR is **not** a regulatory requirement are included in accordance with **Regulation 36** of the Regulations Relating to Banks. For the bank's current perimeter (per `D-REGULATORY-PERIMETER`), `Hoz Securities Limited` is a non-deposit-taking entity and is therefore **excluded** from the consolidated LCR entity set, even though it is in the consolidated ILAAP narrative perimeter; this distinction is explicit so the LCR consolidation does not over-include a non-banking entity.

2. **Summation and entity-level HQLA cap (`ORG-PR-LCR-004`, D1/2022 §4.1.2.5).** The consolidated LCR is computed by **summing** the individual net cash outflows and the HQLA portfolios of all relevant entities. In that summation, each entity's HQLA is **capped at the lower of** the minimum LCR requirement in that entity's relevant jurisdiction **or** the home jurisdiction's minimum. Any **excess** HQLA or inflows of a particular entity are included in the consolidated LCR **only** once evaluated as freely transferable across jurisdictions and convertible across currencies, and freely available to the consolidated (parent) entity in times of stress. Eitan (Treasurer, governance) performs the transferability/convertibility assessment.

3. **Intragroup elimination (`ORG-PR-LCR-005`, D1/2022 §4.1.2.7).** Intragroup transactions between all banking/deposit-taking entities included in the consolidated LCR are **eliminated** for the purpose of the consolidated calculation.

4. **Group-basis inflow cap (`ORG-PR-LCR-006`, D1/2022 §4.1.2.8).** Inflows allowed under the LCR framework from all relevant entities are capped at **75% on a group consolidated basis** (not at entity level).

5. **Rand reporting (`ORG-PR-LCR-007`, D1/2022 §3.1, §4.1.2.10).** The LCR is reported in **Rand** on both a solo and consolidated basis; all LCR calculation components are converted into Rand; and the bank continuously meets its liquidity needs in each currency in which it operates (cross-reference the significant-currency monitoring in §2.4).

6. **Monthly consolidated calculation (`ORG-PR-LCR-008`, D1/2022 §4.1.2.11–§4.1.2.12).** The consolidated LCR is calculated **monthly** to form the base of the public-disclosure requirements, made available to the PA on request, and reported in accordance with the applicable BA-return requirements, with a month-end position group calculation maintained.

**Substrate dependency (policy / build split).** The consolidation **rules** above are the policy-layer discharge of `ORG-PR-LCR-003/004/005` and are in force as policy from commencement of trading. The **consolidated-LCR computation engine** — the substrate that applies these rules across the group perimeter (entity summation, per-jurisdiction HQLA capping, intragroup elimination, 75% group inflow cap, Rand conversion, monthly cadence) — was tracked as the explicit substrate follow-on `GAP-LCR-CONSOLIDATION-ENGINE` (Bea (Accounting & financial reporting engineer, engineering) / Ravi (Treasury / ALM engineer, engineering); W2 Slice 5) and was **delivered 2026-06-10** at `prototype/platform/returns/ba300/consolidated-lcr.ts` under `D-QUEUE-CLOSEOUT-2026-06-10`. See §11.5 for the closure record. This finding's policy half (`F-HELENA-20260608-XF2F`) is closed by this section; the build half is closed by the engine delivery.
...
**Activated obligation status:** `ORG-PR-07` (BCBS D295 / BA 300 series — NSFR) and `ORG-PR-43` (PA D1/2023) — **IN FORCE** from commencement of trading.
...
| Level 2B assets and performing loans to financial institutions: < 6-month maturity | 10–15% | Per BCBS D295 `[citation: TBC]` |
...
| Other loans and assets | Per BCBS D295 schedule `[citation: TBC]` | |
| Undrawn committed credit and liquidity facilities | 5–10% (per counterparty type) | Per BCBS D295 `[citation: TBC]` |
| Off-balance-sheet exposures (other contingent obligations) | Per BCBS D295 schedule `[citation: TBC]` | |
...
2. **NSFR** at each horizon: projected ASF / projected RSF (stress-scenario maturity-shortening applied to the funding profile; stress-ASF factors applied per BCBS D295).
...
### 9.4 Non-compliance written-notification to the PA (`ORG-PR-LCR-010`)

The PA-notification triggers in §9.1 (a ratio breach at the Critical tier) are **not** the full extent of the bank's notification obligation. Per PA Directive 1 of 2022 §4.1.6, read with **Regulation 5** of the Regulations Relating to Banks, **should the bank be unable to comply with *any* of the requirements of D1/2022 — not only the LCR ratio minimum — the bank shall report its inability to comply in writing to the Prudential Authority as soon as practicable, stating the reasons for such failure or inability to comply** `[citation: TBC — D1/2022 §4.1.6 confirmed against `Regulations/Banks/source-docs/banks-d1-2022-structured.json`; Reg 5 sub-clause text pending Imani (Legal-as-code engineer, engineering) + external counsel ratification at the licence-application gate]`.

This is broader than a ratio breach. Examples of non-ratio non-compliance that trigger the §4.1.6 written notification include: inability to perform the monthly consolidated LCR calculation (`ORG-PR-LCR-008`); inability to make the quarterly public disclosure on the required daily-average basis (`ORG-PR-LCR-009`); inability to apply the consolidation rules (§2.6); or any other failure to comply with a D1/2022 requirement.

**Mechanics.** Any such inability is a typed event — `LcrDirectiveNonCompliance { requirementRef, description, asOf, detectedBy }` — raised by Eitan (Treasurer, governance), with the written PA notification prepared under the bank's regulatory-engagement channel and oversight by Zara (Chief Compliance Officer, governance). The written notification is filed as soon as practicable after the inability is identified, independent of whether the LCR ratio itself is in breach. Zara confirms the notification has been dispatched and records the regulatory-correspondence event.
...
|---|---|---|---|
| `ORG-PR-06` | BCBS D238 / BA 300 (Liquidity Risk, incl. LCR) | Maintain LCR ≥ 100% (PA minimum); buffer to internal floor (B2 / B3 calibration) | Section 2 — LCR governance framework; internal floor §2.1 and §2.5; computation §2.3; BA 300 projection substrate |
| `ORG-PR-07` | BCBS D295 / BA 300 series (NSFR) | Maintain NSFR ≥ 100% (PA minimum); buffer to internal floor | Section 3 — NSFR governance framework; internal floor §3.1; computation §3.4; PA D1/2023 phase-out tracking §3.3 |
...
| `ORG-PR-LCR-001` | PA D1/2022 §1.2, §2.3 — HQLA maintenance | Maintain adequate unencumbered HQLA for the 30-day stress, solo + consolidated | Section 2 — LCR framework; §2.1 PA-minimum anchored on D1/2022; §2.2 HQLA composition |
| `ORG-PR-LCR-002` | PA D1/2022 §4.1.1 — LCR disclosure per D1/2019 | Comply with the D1/2019 LCR disclosure requirements (daily-average basis) | §2.3 public-disclosure basis (D1/2022 §3.2 / D1/2019 simple-average-of-daily-observations) |
| `ORG-PR-LCR-003` | PA D1/2022 §4.1.2.1–§4.1.2.4 — consolidation scope | Include only banking/deposit-taking entities; branch home/host; Reg 36 inclusion | §2.6 item 1 (inclusion scope; Hoz Securities excluded as non-deposit-taking) |
| `ORG-PR-LCR-004` | PA D1/2022 §4.1.2.5 — summation + entity HQLA cap | Sum NCO + HQLA; cap entity HQLA at lower of jurisdiction/home minimum; transferability test on excess | §2.6 item 2 (summation and entity-level HQLA cap) |
| `ORG-PR-LCR-005` | PA D1/2022 §4.1.2.7 — intragroup elimination | Eliminate intragroup transactions in the consolidated LCR | §2.6 item 3 (intragroup elimination) |
| `ORG-PR-LCR-006` | PA D1/2022 §4.1.2.8 — 75% group-basis inflow cap | Cap inflows at 75% on a group consolidated basis (not entity level) | §2.6 item 4 (group-basis inflow cap) |
| `ORG-PR-LCR-007` | PA D1/2022 §3.1, §4.1.2.10 — Rand reporting | Report LCR in Rand solo + consolidated; convert all components; meet per-currency liquidity needs | §2.6 item 5 (Rand reporting); §2.4 significant-currency monitoring |
| `ORG-PR-LCR-008` | PA D1/2022 §4.1.2.11–§4.1.2.12 — monthly consolidated calc | Calculate consolidated LCR monthly; available to PA on request; month-end group calc | §2.6 item 6 (monthly consolidated calculation) |
| `ORG-PR-LCR-009` | PA D1/2022 §3.2, §4.1.4 — quarterly public disclosure | Publish LCR quarterly as simple averages of daily observations per D1/2019 | §2.3 public-disclosure basis (daily-average quarterly disclosure) |
| `ORG-PR-LCR-010` | PA D1/2022 §4.1.6 + Reg 5 — non-compliance notification | Report any inability to comply with D1/2022 in writing to the PA, stating reasons | §9.4 non-compliance written-notification (broader than ratio breach) |
| `ORG-PR-NSFR-009` | PA D1/2023 §2.3.6.1 + Reg 26(12)(b)(iii)(D) — RCLF as L2B HQLA | Report the SARB RCLF as Level 2B HQLA | §2.2.1 SARB RCLF Level 2B treatment |
| `ORG-PR-RETURNS-011` | PA D5/2025 §2.1.12 — form BA 310 (Minimum Liquid Reserve Balance and Liquid Assets / HQLA return) | Complete and submit the BA 310 minimum-liquid-reserve / HQLA return to the PA on the prescribed frequency | §2.2 HQLA composition + §2.3 (the HQLA stock and minimum-liquid-reserve position feed the BA 310 return). NB form BA 310 = HQLA / minimum liquid reserve per the Excel-canonical SARB schedule (`D-BA-RETURN-NUMBERING-EXCEL-CANONICAL`) — a liquidity return; the trading-book capital return on form BA 320 (`ORG-PR-RETURNS-012`) is closed separately by the trading-risk policy. |
...
| PA Directive 1 of 2022 — LCR: Scope of Application and Calculation | `ORG-PR-LCR-001`…`ORG-PR-LCR-010` — current SA LCR scope-of-application instrument `[citation: TBC — §§ confirmed against banks-d1-2022-structured.json; Reg 26(12)/Reg 36/Reg 5 sub-clauses pending ratification]` | §1.3, §2.1, §2.2.1, §2.3, §2.6, §9.4 | WS-INSTRUMENT-ANALYSES (Mira + Imani) |
| PA Directive 1 of 2019 — LCR public-disclosure standard | `ORG-PR-LCR-002`, `ORG-PR-LCR-009` — daily-average quarterly disclosure `[citation: TBC — disclosure-template references]` | §2.3 | WS-INSTRUMENT-ANALYSES |
| PA Directive 6 of 2015 — Revised LCR — **superseded reference** | `ORG-PR-36` — earlier SA LCR calibration; retained for lineage `[citation: TBC — precise § references]` | §1.3 (rank 3b), §2.1 | WS-INSTRUMENT-ANALYSES (Mira + Imani) |
...
| BCBS D238 | *Basel III: The LCR and liquidity risk monitoring tools*, January 2013 | §2.1, §2.2, §2.3 | |
| BCBS D295 | *Basel III: The Net Stable Funding Ratio*, October 2014 | §3.1, §3.2 | |
...
| v1.2 | 2026-06-26 | Mira (Compliance / RegTech engineer, compliance) under Zara (Chief Compliance Officer, governance); domain co-authority Eitan (Treasurer) + Helena (CRO) | BCBS document-number remediation only (no substantive policy change). Corrected the Basel liquidity-standard numbers validated against the BIS source (domain-truth oracle) per `D-BCBS-CITATION-NUMBERING-REMEDIATION`: **LCR = BCBS d238** (*Basel III: The Liquidity Coverage Ratio and liquidity risk monitoring tools*, January 2013) — was wrongly cited as D295; **NSFR = BCBS d295** (*Basel III: the net stable funding ratio*, October 2014) — was wrongly cited as D335 (d335 is the RCAP Saudi Arabia assessment, not the NSFR). All §-paragraph indices and dates unchanged; only the BCBS document numbers corrected. |
| v1.2 | 2026-06-09 | Helena (Chief Risk Officer, governance) — via Scrooge dispatch `brief:helena:close-seven-open-vera-audit-findings-liquidity-m:2026-06-09`; authority `D-OPEN-THREADS-CLOSEOUT-2026-06-09` (CEO session-delegation) | Remediation of five Vera (internal audit engineer) findings. **`F-HELENA-20260608-8AO0`** (D1/2022 cluster unclosed; policy anchored stale D6/2015): re-anchored §1.3 regulatory hierarchy on **PA Directive 1 of 2022** (current LCR scope-of-application instrument) with D1/2019 as the disclosure standard and D6/2015 demoted to superseded-lineage; updated §2.1 PA-minimum + activated-obligation status; added `ORG-PR-LCR-001`…`ORG-PR-LCR-010` to the §10 closure table. Also added `ORG-PR-RETURNS-011` (form BA 310 — Minimum Liquid Reserve Balance and Liquid Assets / HQLA return) to the §10 closure table — a liquidity return per the Excel-canonical SARB form schedule (`D-BA-RETURN-NUMBERING-EXCEL-CANONICAL`); the trading-book capital return on form BA 320 is closed separately by the trading-risk policy. **`F-HELENA-20260608-D9IJ`** (RCLF missing from L2B HQLA): added §2.2.1 specifying the SARB RCLF as Level 2B HQLA per D1/2023 §2.3.6.1 / Reg 26(12)(b)(iii)(D) (`ORG-PR-NSFR-009`). **`F-MIRA-20260608-YQNK`** (public LCR disclosure basis unreconciled): added the §2.3 public-disclosure-basis provision (D1/2022 §3.2 / D1/2019 simple averages of daily observations, quarterly; `ORG-PR-LCR-002/009`). **`F-HELENA-20260608-96I3`** (notification narrower than D1/2022 §4.1.6): added §9.4 non-compliance written-notification covering *any* inability to comply with D1/2022 (not only a ratio breach), per §4.1.6 + Reg 5 (`ORG-PR-LCR-010`). **`F-HELENA-20260608-XF2F`** (consolidation rules unspecified — policy half only): added §2.6 specifying the D1/2022 consolidation rules (inclusion scope, summation + entity HQLA cap, intragroup elimination, 75% group inflow cap, Rand reporting, monthly cadence; `ORG-PR-LCR-003/004/005/006/007/008`); the consolidated-LCR computation engine is recorded as the tracked substrate follow-on `GAP-LCR-CONSOLIDATION-ENGINE` in §11.5 and is explicitly out of scope of this policy amendment. No substantive change to the NSFR, intraday, CFP, ILAAP, or stress-testing frameworks. |
| v1.3 | 2026-06-10 | Bea (Accounting & financial reporting engineer, engineering) — via Scrooge dispatch `brief:bea:close-gap-lcr-consolidation-engine-consolidated-:2026-06-10`; authority `D-QUEUE-CLOSEOUT-2026-06-10` (CEO-approved 2026-06-10) | **Build-half closure of `GAP-LCR-CONSOLIDATION-ENGINE` only — no policy-rule change.** The consolidated-LCR computation engine specified by §2.6 was delivered at `prototype/platform/returns/ba300/consolidated-lcr.ts` (workstream `WS-LCR-ENGINE-RECONCILIATION`): perimeter resolution over the versioned legal-entity tree (`ORG-PR-LCR-003`), entity-level HQLA cap with Eitan (Treasurer, governance) transferability gate (`ORG-PR-LCR-004`), intragroup-elimination schedule (`ORG-PR-LCR-005`), 75% group-basis inflow cap (`ORG-PR-LCR-006`), Rand reporting (`ORG-PR-LCR-007`), monthly-cadence meta (`ORG-PR-LCR-008`). §2.6 substrate-dependency note and the §11.5 gap row updated from OPEN (build) to CLOSED (build); closure event `WorkstreamCompleted{workstreamId: GAP-LCR-CONSOLIDATION-ENGINE}` emitted to the shared event store. |
| v1.4 | 2026-06-11 | Helena (Chief Risk Officer, governance — policy owner) — via Scrooge dispatch `brief:helena:appetite-liquidity-intraday-ras-line-calibrate-b:2026-06-11`; authority `D-TREASURER-WAVE1-SUBSTRATE` (CEO-approved 2026-06-11) + `D-INTRADAY-RAS-APPETITE` (CRO-approved 2026-06-11) | **§5.2 erratum — internal-consistency correction, not a policy change of substance.** The Tier-2 typed-event pattern literal `LcrRatioBreach { threshold: 115 }` contradicted the same row's prose ("LCR falls below the internal floor of **120%** but remains ≥ 100%") and §2.1's 120% internal floor; the `115` literal appears to have been transposed from the NSFR internal floor (§3.1). Corrected to `threshold: 120`, matching the prose rule that PR #1206's CFP EWI monitor (`prototype/platform/alm/cfp-ewi.ts`, `LCR_INTERNAL_FLOOR_PCT = 120`) already implements. Also under the same dispatch (recorded here for the §4 framework, no policy-text change): the `appetite:liquidity:intraday` RAS appetite line is now live in the canonical register (`prototype/platform/risk/ras-appetite-register.ts`) — headline measure `peakUsagePctOfAvailable` (BCBS 248 tools 1/2), red band at the §4.5 80% stress trigger, governed R50m intraday floor (`floorZar`) read by `prototype/platform/alm/intraday-stress.ts`. |

### 11.5 Substrate gaps (policy / build split)

Per Principle 1, gaps are surfaced explicitly, not hidden. The following substrate item is the build-side follow-on to the policy-layer discharge of the D1/2022 consolidation rules (§2.6):

| Gap ID | Description | Policy half | Build half (follow-on) | Owner | Status |
|---|---|---|---|---|---|
| `GAP-LCR-CONSOLIDATION-ENGINE` | Consolidated-LCR computation engine implementing the D1/2022 §4.1.2 consolidation rules: per-entity summation of net cash outflows + HQLA, entity-level HQLA capping at the lower of jurisdiction/home minimum, transferability/convertibility evaluation of excess HQLA, intragroup-transaction elimination, 75% group-basis inflow cap, Rand conversion of all components, monthly cadence + month-end group position calculation. | **Closed** by §2.6 (rules specified at the policy layer; `F-HELENA-20260608-XF2F` policy half) | **Closed** 2026-06-10 — engine delivered at `prototype/platform/returns/ba300/consolidated-lcr.ts` (Bea (Accounting & financial reporting engineer, engineering); authority `D-QUEUE-CLOSEOUT-2026-06-10`; workstream `WS-LCR-ENGINE-RECONCILIATION`). Implements all six §2.6 rules: tree-derived perimeter (`ORG-PR-LCR-003`), entity HQLA cap + Eitan (Treasurer, governance) transferability gate (`ORG-PR-LCR-004`), intragroup elimination (`ORG-PR-LCR-005`), 75% group-basis inflow cap (`ORG-PR-LCR-006`), Rand reporting (`ORG-PR-LCR-007`), monthly cadence meta (`ORG-PR-LCR-008`). Composes the solo BA 300 substrate without forking it; solo-vs-consolidated golden reconciliation tested. The legal-entity tree carries exactly one banking entity today, so the multi-entity path is exercised by a synthetic-second-entity test fixture; production runtime scheduling of the consolidated run binds to the period-close flow when a second banking entity is registered. Closure event: `WorkstreamCompleted{workstreamId: GAP-LCR-CONSOLIDATION-ENGINE}` in the shared event store. | Bea (Accounting & financial reporting engineer, engineering) / Ravi (Treasury / ALM engineer, engineering); governance Eitan (Treasurer, governance) + Helena (Chief Risk Officer, governance) | CLOSED (build, 2026-06-10) / policy half closed |
