...
agent: Rohan
trigger: risk-run
asOf: 2026-06-05T05:58:16.954Z
decision-required: false
---

# Rohan — daily risk run, 2026-06-05
...
**Headline:** 13 appetite lines tracked · measurement readiness 0 ready / 3 drafting / 7 specified / 3 not-yet-specified · 0 position events (last 7d) · 672 RiskRaised events.

## Helena's latest snapshot

Latest `RiskAppetiteSnapshot` event: 2026-06-05T05:58:02.324Z
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbjbkkFaGQH88kAqGJMwP"})._
