...
//
// Tests for the BA 325 LCR generator — specifically the SecurityMaster HQLA
...
/**
 * Build a minimal Ba325GeneratorInput with the given classifications and
...
describe("generateBa325Lcr() without hqlaOverrides", () => {
...
describe("generateBa325Lcr() with hqlaOverrides — override tier replaces COA tag", () => {
...
describe("generateBa325Lcr() with hqlaOverrides — COA fallback for accounts without ISIN", () => {
...
describe("generateBa325Lcr() with hqlaOverrides — non-hqla override", () => {
...
describe("generateBa325Lcr() with hqlaOverrides — override note in lineItem", () => {
...
describe("generateBa325Lcr() — citation coverage", () => {
