...
All Slice 4 stub rows have been resolved. The posting rules, GL account codes, and event types are live (D-TRADE-LIFECYCLE-IFRS-CHAIN Slice 4 complete, 2026-05-18). Procedure references now point to the live posting-rules source files.
...
| Trade execution — bonds | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1A (trade-date) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `BondTradeExecuted` | PR-BOND-001 (FVTPL); PR-BOND-001T (amortised cost) | ACC-3100 (bonds FVTPL), ACC-3101 (bonds FVOCI/AC) | IFRS 9 §3.1.1; IFRS 9 §5.1.1 | Bonds-T; Bonds-AC |
| Trade execution — equities | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1A (trade-date) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `EquityTradeExecuted` | PR-EQ-001 (FVTPL); PR-EQ-001F (FVOCI) | ACC-3200 (equities FVTPL), ACC-3201 (equities FVOCI) | IFRS 9 §3.1.1; IFRS 9 §5.1.1 | Eq-FVTPL; Eq-FVOCI |
| Trade execution — OTC IRD | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1A (trade-date) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `IrdSwapTradeExecuted` | PR-IRD-001 | ACC-3300 (IRD asset), ACC-3301 (IRD liability) | IFRS 9 §3.1.1; IFRS 9 §5.1.1 | IRD |
...
| Daily MTM — bonds FVTPL | [`pricing-policy-v1`](../../Policies/pricing-policy-v1.md) §3.3A | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `BondPositionRevalued` | PR-BOND-002 | ACC-3101 (bonds FVTPL MTM), ACC-3105 (unrealised bond P&L) | IFRS 9 §5.7.1 | Bonds-T |
| Daily EIR accrual — bonds amortised cost | [`pricing-policy-v1`](../../Policies/pricing-policy-v1.md) §3.3A; [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1.2 | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `BondInterestAccrued` | PR-BOND-EIR | ACC-3102 (bonds AC carrying amount), ACC-4101 (interest income) | IFRS 9 §5.4.1 | Bonds-AC |
| Daily MTM — equities FVTPL | [`pricing-policy-v1`](../../Policies/pricing-policy-v1.md) §3.3A | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `EquityPositionRevalued` | PR-EQ-002 | ACC-3200 (equities FVTPL), ACC-3205 (unrealised equity P&L FVTPL) | IFRS 9 §5.7.1 | Eq-FVTPL |
| Daily MTM — equities FVOCI | [`pricing-policy-v1`](../../Policies/pricing-policy-v1.md) §3.3A; [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1.3 | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `EquityPositionRevalued` | PR-EQ-002F | ACC-3201 (equities FVOCI), ACC-3206 (OCI reserve — equity FVOCI) | IFRS 9 §5.7.5 | Eq-FVOCI |
| Daily MTM — OTC IRD FVTPL | [`pricing-policy-v1`](../../Policies/pricing-policy-v1.md) §3.3A | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `IrdSwapPositionRevalued` | PR-IRD-002 | ACC-3300/ACC-3301 (IRD asset/liability), ACC-3305 (unrealised IRD P&L) | IFRS 9 §5.7.1 | IRD |
...
| Bond maturity / derecognition | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1B (derecognition) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `BondMatured` | PR-BOND-MAT | ACC-3100/3101 (derecognise bond), ACC-1100-x (cash) | IFRS 9 §3.2.3 | Bonds-T; Bonds-AC |
| Bond sale / derecognition | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1B (derecognition) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `BondSold` | PR-BOND-SALE | ACC-3100/3101 (derecognise bond), ACC-1100-x (cash), P&L | IFRS 9 §3.2.3 | Bonds-T; Bonds-AC |
| Equity sale — FVTPL | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1B (derecognition) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `EquitySold` | PR-EQ-SALE | ACC-3200 (derecognise), ACC-1100-x (cash), ACC-3205 (close unrealised P&L → realised) | IFRS 9 §3.2.3 | Eq-FVTPL |
| Equity sale — FVOCI (irrevocable) | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1B; §3.1.3 (no recycling) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `EquitySold` | PR-EQ-SALE-F | ACC-3201 (derecognise), ACC-1100-x (cash), ACC-3206 → retained earnings (OCI balance transferred, not recycled to P&L) | IFRS 9 §5.7.5 (no P&L recycling on sale) | Eq-FVOCI |
| IRD swap coupon settlement | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1B | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `IrdSwapCouponSettled` | PR-IRD-COUP | ACC-3300/3301 (coupon leg), ACC-1100-x (cash) | IFRS 9 §5.4 | IRD |
| IRD swap termination / derecognition | [`accounting-policies-ifrs-v1`](../../Policies/accounting-policies-ifrs-v1.md) §3.1B (derecognition) | [`platform/accounting/posting-rules/`](../../prototype/platform/accounting/posting-rules/) — Slice 4 live | `IrdSwapTerminated` | PR-IRD-TERM | ACC-3300/3301 (derecognise), ACC-1100-x (cash) | IFRS 9 §3.2.3 | IRD |
...
| PR-BOND-001 | Bond trade booking — FVTPL initial recognition | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-BOND-001T | Bond trade booking — amortised cost initial recognition | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-BOND-002 | Bond daily MTM — FVTPL fair value change | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-BOND-EIR | Bond EIR accrual — amortised cost interest income | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-BOND-MAT | Bond maturity / derecognition | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-BOND-SALE | Bond sale / derecognition | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-EQ-001 | Equity trade booking — FVTPL initial recognition | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-EQ-001F | Equity trade booking — FVOCI initial recognition (irrevocable election) | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-EQ-002 | Equity daily MTM — FVTPL fair value change through P&L | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-EQ-002F | Equity daily MTM — FVOCI fair value change through OCI | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-EQ-SALE | Equity sale — FVTPL derecognition; realise P&L | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-EQ-SALE-F | Equity sale — FVOCI derecognition; OCI to retained earnings (no recycling) | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-IRD-001 | IRD swap booking — FVTPL initial recognition (zero NPV at-market; off-market as Dr/Cr P&L) | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-IRD-002 | IRD swap daily MTM — NPV delta through P&L; asset↔liability sign-flip journal | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-IRD-COUP | IRD swap net coupon settlement — bank receives / pays net cash vs swap carrying value | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-IRD-TERM | IRD swap termination / derecognition — carry NPV off B/S; settle termination payment; realised P&L | Live (Slice 4 / D-TRADE-LIFECYCLE-IFRS-CHAIN) |
| PR-ECL-001 | ECL provision — stage change booking | PLANNED — Slice 5 |
...
|---|---|---|
| PR-FX-REV, PR-FX-CANCEL, PR-FX-AMD, PR-SET-001 posting rule implementations | Bea (Chief Financial Officer, finance) | D-TRADE-LIFECYCLE-IFRS-CHAIN Slice 5 |
...
| ECL staging cycle procedure (`ecl-staging-cycle.md`) and PR-ECL-001 implementation | Bea (Chief Financial Officer, finance) | Slice 5 |
...
| v1.1 | 2026-05-18 | Bea (Chief Financial Officer, finance) | Slice 4 complete. All `[stub — Slice 4]` entries resolved. Posting rules PR-BOND-001/EIR/002/MAT/SALE, PR-EQ-001/002/SALE/FVOCI, PR-IRD-001/002/COUP/TERM all live. PRs A (bonds), B (equities), C (IRD swaps) merged under D-TRADE-LIFECYCLE-IFRS-CHAIN. Substrate gaps updated. |
