...
| Saskia (derivatives trading desk, engineering) | Application initiator (`CreditLimitApplicationSubmitted`); operates within loaded limits; surfaces extension requests |
