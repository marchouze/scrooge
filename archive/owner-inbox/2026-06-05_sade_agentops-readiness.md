...
asOf: 2026-06-05T07:41:25.499Z
decision-required: false
---

# Sade — AgentOps readiness snapshot, 2026-06-05
...
**Headline:** 31 agents registered (latest 2026-06-01T07:02:45.981Z) · 17 Sade-owned obligations on the register (0 IN FORCE; 1 PARTIAL; 2 PLANNED) · 19 AgentRegistered + 0 AgentRetired in the last 7 days.

## Agent-fleet registry

| Item | State |
|---|---|
| Registered agents (latest-wins per `agentUrn`) | 31 |
| Latest `AgentRegistered` event | 2026-06-01T07:02:45.981Z |
...
| `AgentRegistered` | 19 |
| `AgentRetired` | 0 |
| `IdentityKeyRotated` | 399 |
| `PermissionPolicyPublished` | 184 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbjjcvqX1TxPi8JnycUZY"})._
