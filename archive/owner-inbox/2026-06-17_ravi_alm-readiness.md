...
asOf: 2026-06-17T05:37:49.873Z
decision-required: false
---

# Ravi — ALM readiness, 2026-06-17
...
**Headline:** 9 ALM pipelines tracked · readiness 0 ready / 2 drafting / 7 specified / 0 not-yet-specified · 7 Ravi-owned obligations indexed (0 PARTIAL / drafting) · 76 ALM-domain events (last 7d).

## Eitan's latest snapshot

Latest `LiquiditySnapshot` event: 2026-06-15T07:13:56.565Z
...
| ORG-MK-08 | [TBD] | Excon Compliance Policy (planned); Funding Strategy Policy | head-of-global-markets |
...
| `CollateralUpdated` | 0 |
| `FundingDrawnDown` | 0 |
| Prior `ALMReadinessSnapshot` (this agent) | 11 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cc8HuGumTXGTd25NRVSD5"})._
