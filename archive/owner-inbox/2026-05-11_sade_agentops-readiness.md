...
asOf: 2026-05-11T05:51:51.299Z
decision-required: false
---

# Sade — AgentOps readiness snapshot, 2026-05-11
...
**Headline:** 27 agents registered (latest 2026-05-11T03:51:03.435Z) · 17 Sade-owned obligations on the register (14 IN FORCE; 1 PARTIAL; 2 PLANNED) · 27 AgentRegistered + 0 AgentRetired in the last 7 days.

## Agent-fleet registry

| Item | State |
|---|---|
| Registered agents (latest-wins per `agentUrn`) | 27 |
| Latest `AgentRegistered` event | 2026-05-11T03:51:03.435Z |
...
| `AgentRegistered` | 27 |
| `AgentRetired` | 0 |
| `IdentityKeyRotated` | 27 |
| `PermissionPolicyPublished` | 27 |
