...
function renderStrategyBanner(state) {
  ...
  banner.innerHTML = `<span class="banner-phase">Phase: ${esc(phase)}</span><span class="banner-sep"> · </span><span>${openCount} decision${openCount === 1 ? "" : "s"} open</span><span class="banner-sep"> · </span><span>${agentCount} agent${agentCount === 1 ? "" : "s"} reporting</span>`;
}
