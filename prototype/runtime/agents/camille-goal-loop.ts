...
const MONTHLY_CLOSE_GOAL =
  "Approve monthly close" as const;
const EXTERNAL_AUDITOR_GOAL =
  "Approve external-auditor interface decisions" as const;
