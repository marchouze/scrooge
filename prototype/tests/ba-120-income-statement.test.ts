// tests/ba-610-income-statement.test.ts
//
// WS-FINANCE-BA-RETURNS-QUINTET — exit-criterion tests for the BA 610
...
describe("BA 610 — canonicaliser determinism", () => {
