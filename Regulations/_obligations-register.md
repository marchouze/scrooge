...
**Curator:** Mira (Compliance / RegTech engineer) · **Governance:** Zara (Chief Compliance Officer) · **Date:** 2026-05-09 · **Version:** 1.7
...
|---|---|---|---|---|---|---|
| ORG-FX-FIN-01 | `urn:obligation:bank:mk:finsurv:current-account-trade-payments:v1` | Currency and Exchanges Manual for Authorised Dealers, Section B (Current Account — Trade in Goods) [citation: TBC sub-section]; FinSurv Reporting System Manual, BoP category cluster 100-series (merchandise trade) [citation: TBC precise codes] | Report every cross-border ZAR-vs-foreign-currency payment for goods (imports / exports) to SARB FinSurv with the correct merchandise-trade BoP category code, on behalf of the underlying client. Verify supporting trade documents (commercial invoice, transport document, customs documentation) before execution per Authorised Dealer obligation. | Excon Compliance Policy (planned, markets bundle); `Procedures/by-policy/finsurv-reporting.md` (planned per `2026-05-07_saskia-kai_fx-product-family.md` §6); `prototype/` system capability TBD (Mira engineering) | Zara (Mira); Eitan secondary | DRAFTING |
...
| corporate-bind | ~6 | Domain P FAIS Posture A binding — `ORG-FAIS-KI` closure + 5 FAIS-record-keeping URNs (per `D-FSP-LICENCE-NECESSITY`, 2026-05-09); binds at corporate formation per `project_rules_bind_at_commencement.md` |

**Total tracked obligations: ~207** across 15 domains and ~65 instruments.
