...
asOf: 2026-06-04T05:59:47.106Z
decision-required: false
---

# Ravi — ALM readiness, 2026-06-04
...
**Headline:** 9 ALM pipelines tracked · readiness 0 ready / 2 drafting / 7 specified / 0 not-yet-specified · 7 Ravi-owned obligations indexed (0 PARTIAL / drafting) · 33 ALM-domain events (last 7d).

## Eitan's latest snapshot

Latest `LiquiditySnapshot` event: 2026-06-03T07:13:21.575Z
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cbhi4TZvGzHiHW5cZo9ve"})._
