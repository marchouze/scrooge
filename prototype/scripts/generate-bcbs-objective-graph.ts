...
// 1,921 nodes from the 14 obligation-graph JSONs, seeded by
// importBcbsObligationGraphs in a clean graph). This script does NOT
...
for (const [pol, objective] of ALIGNS) {
  ...
  edges.push(
    edge(
      `OBJ-BCBS-ALIGNS_TO-${alignIdx}-${OBJ_SUFFIX[objective]}`,
      pol,
      objective,
      "ALIGNS_TO",
      CHARTER,
