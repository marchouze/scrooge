---
title: Codebase quality review — 2026-05-25
author: Vera (Internal audit engineer, third-line)
date: 2026-05-25
summary: 3 recons run; 0 fail / 3 warn / 2 info findings across 2037 assertions.
decision-required: false
authority: GOV-FRAMEWORK-CAE-INDEPENDENCE
---

# Codebase quality review — 2026-05-25
...
|---|---|---|---|---|
| code-quality:any-density | 1018 | 0 | 0 | 1 |
| code-quality:swallowed-errors | 1018 | 0 | 3 | 0 |
...
- `code-quality:any-density` — 6 `any` occurrences across 1018 files scanned (threshold 3/file).
