...
const ENTRY = {
  ...
  outcome:
    "Mira (Compliance / RegTech engineer, engineering — reports to Zara CCO; obligations-register curator) and Imani (Legal-as-code engineer, engineering — reports to Devon COO interim; legal sourcing co-author) survey the SARB Prudential Authority publications portal (Directives, Joint Standards, Guidance Notes, Circulars, Prudential / Joint Communications) and add 13 new register rows across four domains: Domain A (Prudential) — 8 rows for D1/2025 + D10/2025 (Pillar 3 disclosure), D2/2024 (BA-return reporting under Reg 46), the PA recovery-and-resolution-planning Directive (Imani follow-up on precise instrument identification), G3/2023 (Basel implementation dates), G3/2025 (Climate Disclosures for banks — supersedes G3/2024 + G2/2024), Prudential Communication 18/2024 (FRTB + CVA implementation roadmap), Prudential Communication 15/2024 (CSRBB Field testing); Domain B (Financial crime) — 1 row for AML/CFT/CPF Communication 1/2025 (Banks); Domain G (Cyber / IT) — 3 rows for Joint Standard 1/2023 (IT Governance + IT Risk Management — split into two umbrella rows ORG-CY-08 + ORG-CY-09) and a corrective umbrella row ORG-CY-10 for Joint Standard 2/2024 (Cybersecurity and Cyber Resilience — flagging the long-standing JS-1-vs-JS-2-of-2024 mis-citation across ORG-CY-01..05 + ORG-BNK-CYBER-CONS, routed for single-purpose follow-on PR via WS-JS-NUMBER-RECONCILIATION); Domain JS (Joint Standards) — 1 row for Joint Standard 1/2020 (Significant Owner). Filtered out per the wholesale-institutional bank profile (project_strategic_foundation.md): D1/2024 + D2/2024 NPS-side directives (the bank is an indirect NPS participant via correspondent — project_indirect_participant_posture.md); JS 1/2024 (Outsourcing by Insurers — insurer-only); G2/2024 (insurer climate disclosures); meta-instruments C1/2024 + G1/2024 + C1/2023; informational PA / Joint Communications. Six substrate gaps surfaced and routed: WS-JS-NUMBER-RECONCILIATION (Mira), WS-PA-CIRCULAR-INVENTORY (Imani), D1/2025-vs-D10/2025 supersession resolution (Imani), recovery-and-resolution-planning Directive identification (Imani), GN-1/2024-vs-G3/2024 climate-reading clarification (Imani), JS-1/2023 sub-section coverage expansion (Senna + Rashida at first IT-control attestation). Seven new procedure stubs routed to downstream policy authors: Pillar 3 disclosure (Camille + Bea), BA returns Reg 46 (Bea + Camille), recovery-and-resolution planning (Helena + Camille), climate-related disclosures (Helena), IT-governance JS 1/2023 (Devon + Senna + Rashida), AML/CFT/CPF banks supervisory engagement (Zara + Mira + future MLRO), significant-owner notification (Owen + Camille). The seven [citation: TBC] markers added in v1.14 fold into the standing WS-INSTRUMENT-ANALYSES workstream for precise § / clause resolution.",
  comment:
