// tests/ba-110-lcr.test.ts
//
// D-REPORTING-CAPABILITY-M2-M3-BUILD-PLAN Slice 3 — exit-criterion tests
// for the BA 110 (LCR) generator + JSON renderer + per-account
...
describe("D-REPORTING-CAPABILITY-SLICE-3 — end-to-end (events → close → BA 110)", () => {
  function setupStore(): {
    store: EventStore;
  ...
  it("computes a known BA 110 from synthetic events; LCR ≥ 100% with substantial Level-1 stock", () => {
...
// =====================================================================
// 9. G-3 input-completeness meta flag (Eitan BA 110 first end-to-end
