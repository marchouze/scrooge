...
asOf: 2026-06-12T03:25:22.676Z
decision-required: false
---

# Anya — projection drift, 2026-06-12
...
| Owner Inbox deliverables | 736 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-12T03:24:56.549Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbxeksKNhepwyYcgqntxy"})._
