...
asOf: 2026-06-06T07:54:17.108Z
decision-required: false
---

# Eitan — liquidity snapshot, 2026-06-06
...
| Prior `LiquiditySnapshot` (this agent) | 9 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbmeRDSjo63zRgkCp6yn6"})._
