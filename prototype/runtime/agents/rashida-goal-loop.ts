...
// ---------------------------------------------------------------------------
const RASHIDA_BRIEF_DISPATCH: GoalLoopBriefDispatchConfig = {
  agentSlug: "rashida",
...
const handler = async (ctx: AgentRunContext): Promise<AgentRunOutput> => {
  ...
  const openBriefs = selectedDecision && !ctx.dryRun ? openBriefsListForAgent("rashida") : [];
