...
asOf: 2026-06-11T03:17:47.604Z
decision-required: false
---

# Anya — projection drift, 2026-06-11
...
| Owner Inbox deliverables | 717 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-11T03:17:35.585Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbvkNQjnzwFqxWTDLwZ9B"})._
