...
agent: Rohan
trigger: risk-run
asOf: 2026-06-06T07:54:07.906Z
decision-required: false
---

# Rohan — daily risk run, 2026-06-06
...
**Headline:** 13 appetite lines tracked · measurement readiness 0 ready / 3 drafting / 7 specified / 3 not-yet-specified · 0 position events (last 7d) · 490 RiskRaised events.
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbmeQZtXjWXh8GxQiHmZV"})._
