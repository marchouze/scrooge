// tests/ba-100-balance-sheet.test.ts
//
// WS-FINANCE-BA-RETURNS-QUINTET — exit-criterion tests for the BA 100
...
describe("BA 100 — per-entity isolation", () => {
...
// ---------------------------------------------------------------------------
// 2. End-to-end events → close → BA 100.
// ---------------------------------------------------------------------------

describe("BA 100 — end-to-end (events → close → BA 100)", () => {
  function setupClose(): {
    store: EventStore;
  ...
  it("produces a balanced BA 100 from synthetic events", () => {
...
describe("BA 100 — balance invariant", () => {
  const unbalanced = {
    entity: ENTITY_BANK,
    asOf: "2026-05-31T23:59:59.999Z",
    periodId: "x",
...
describe("BA 100 — sign-convention warnings + classification gaps", () => {
...
describe("BA 100 — canonicaliser determinism", () => {
...
describe("BA 100 — boundary errors", () => {
...
describe("BA 100 — per-currency totals", () => {
