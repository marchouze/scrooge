...
asOf: 2026-06-12T07:09:58.709Z
decision-required: false
---

# Imani — Legal-readiness snapshot, 2026-06-12
...
**Headline:** 78 Imani-owned obligations on the register (0 IN FORCE; 0 IN FLIGHT; 1 PARTIAL; 62 PLANNED) · 0 master agreements signed (last 7d) · clause-library version-published: **no — substrate gap** · legal-entity tree count: 1.
...
| Prior `LegalReadinessSnapshot` runs (last 30d) | 2 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbxwtFbzQ7BZ5sf5q26i4"})._
