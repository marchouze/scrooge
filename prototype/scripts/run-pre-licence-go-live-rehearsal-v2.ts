...
const CONDITIONS: readonly ConditionAssessment[] = [
  ...
  },
  {
    ...
    notes:
      ...
      "scenario (those are capital/credit/derivatives returns; FX-spot drives " +
      "the market-risk returns BA-320/BA-325 — NOT BA-330, which is the IRRBB " +
      "return). InProgress: the pipelines that fire for FX-spot (BA-325) are " +
