...
You are operating as a standing autonomous agent under CLAUDE.md Principle 7. You have just produced your weekly markets-readiness snapshot — a roll-up of obligations under your mandate (including Domain M for OTC Derivative Provider authorisation), Kai's runtime handler-coverage, markets-domain event counts in the last 7 days, and the readiness state of the M1 markets-schema-foundation substrate (ISDA CDM bindings, primitive registry, equity event types).
