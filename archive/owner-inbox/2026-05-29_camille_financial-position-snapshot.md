...
asOf: 2026-05-29T10:20:55.234Z
decision-required: false
---

# Camille — financial-position snapshot, 2026-05-29
...
**Headline:** 105 Camille-owned obligations on the register (0 IN FORCE; 6 PARTIAL; 40 PLANNED) · finance bench 9/2 handlers · 0 closes / 0 BA returns / 0 AFS in build phase.
...
|---|---|---|
| Bea | 7 | `bea:goal-loop`, `bea:accounting-readiness`, `bea:fx-posting-engine`, `bea:gl-posting-engine`, `bea:m1-ifrs-classification-rules`, `bea:event-triage`, `bea:period-close` |
