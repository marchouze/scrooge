...
//
// Sub-ledger projection — M1 equity slice.
//
...
//
// The FX-spot sub-ledger fold (buildFxSubLedger / fxSubLedgerProjection) was
// retired under the SLA full-retirement workstream (D-SLA-ENGINE-RULES-AS-DATA):
// it was a test-only projection never wired into the runtime mapping. The live
// FX sub-ledger is built off the SLA-interpreter SubLedgerPostingEmitted stream
// (see platform/accounting/fx-subledger-trade-reconciliation.ts and the
// coa-registry sub-ledger view).
//
