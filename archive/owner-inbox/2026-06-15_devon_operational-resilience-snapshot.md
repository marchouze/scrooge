...
asOf: 2026-06-15T05:23:28.850Z
decision-required: false
---

# Devon — operational-resilience snapshot, 2026-06-15
...
**Headline:** 6-seat engineering bench · 29 runtime handlers live · 0 incidents (last 7d) · 158 upstream snapshots observed · 1 substrate exception on register.
...
|---|---|---|
| Atlas — `SubstrateStateSnapshot` | weekly | 150 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cc4VBywnrntfReib3ktLz"})._
