...
asOf: 2026-06-11T06:07:02.181Z
decision-required: false
---

# Yael — tax readiness, 2026-06-11
...
**Headline:** 2 Yael-owned obligations on the register (0 IN FORCE; 0 PARTIAL; 1 PLANNED) · 9 tax cycles tracked (0 ready / 0 drafting / 4 specified / 5 not-yet-specified) · 0 drafts / 0 approvals in last 7 days · Camille anchor: present.
...
| Field | Value |
|---|---|
| Latest `FinancialPositionSnapshot` as_of | 2026-06-08T06:41:04.308Z |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbvyGwmSXjLdgSjChWNcD"})._
