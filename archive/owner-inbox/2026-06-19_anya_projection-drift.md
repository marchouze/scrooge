...
asOf: 2026-06-19T03:17:39.865Z
decision-required: false
---

# Anya — projection drift, 2026-06-19
...
| Owner Inbox deliverables | 835 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-19T03:17:15.903Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CcBtqAYzua5Bubg5KrPba"})._
