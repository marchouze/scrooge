...
| `ORG-PR-06` (BCBS D295 / BA 110) | LCR ≥ 100% (PA min) with internal buffer. |
| `ORG-PR-07` (BCBS D335 / BA 120) | NSFR ≥ 100% (PA min) with internal buffer. |
...
| 10 | Generate BA 100 / BA 110 / BA 120 return content | `system` | `@domains/capital/ba-returns` + `@domains/liquidity/ba-returns` (`PLANNED`) | Generated per P6 — never assembled. Camille signs the generated content. |
...
- **Events produced:**
  ...
  - `BAReturnGenerated { return: 'BA-100' | 'BA-110' | 'BA-120', as_of, content_hash }`.
