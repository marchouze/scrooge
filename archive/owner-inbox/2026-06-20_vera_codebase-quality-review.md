---
title: Codebase quality review — 2026-06-20
author: Vera (Internal audit engineer, third-line)
date: 2026-06-20
summary: 3 recons run; 0 fail / 1 warn / 2 info findings across 4125 assertions.
decision-required: false
authority: GOV-FRAMEWORK-CAE-INDEPENDENCE
---

# Codebase quality review — 2026-06-20
...
|---|---|---|---|---|
| code-quality:any-density | 2062 | 0 | 0 | 1 |
| code-quality:swallowed-errors | 2062 | 0 | 1 | 0 |
...
- `code-quality:any-density` — 15 `any` occurrences across 2062 files scanned (threshold 3/file).
