...
| Marc | **CEO** + executive director + Public Officer + interim Banks Act CFO + interim FAIS Key Individual (until Saskia's fit-and-proper file completes — counsel scope-gate closed by D-FSP-LICENCE-NECESSITY confirm-A, 2026-05-09) | Banks Act + Companies Act + Tax Admin Act + FAIS s.8 + Determination of Fit and Proper Requirements 2017 | Marc | Already in seat |
...
- **Steady state (confirmed):** Saskia (Head of Global Markets, governance) — **steady-state FAIS Key Individual under FAIS s.8 + Determination of Fit and Proper Requirements 2017, subject only to the fit-and-proper file completion (Saskia's PR #45 Gate (b))**. The counsel scope-gate (Gate (a)) is **closed** by D-FSP-LICENCE-NECESSITY (CEO confirm-A, 2026-05-09; record at `Owner Inbox/2026-05-09_scrooge_ceo-decision-record_d-fsp-licence-necessity-confirm-a.md`, PR #62): the bank pursues an FSP licence under FAIS Act 37 of 2002, FAIS Categories I and II likely sufficient (counsel ratifies at licence-application gate; does not evaluate Posture B). Saskia's KI appointment is **not** contingent on counsel — only on the fit-and-proper file.
- **Interim:** Marc retains FAIS KI accountability **until Saskia's fit-and-proper file completes** (Saskia's PR #45 Gate (b); fit-and-proper file template owned by Sade — substrate gap noted in the decision record). The earlier "until external counsel confirms whether the bank's institutional-only / wholesale posture requires an FSP licence at all" wording is **superseded** by D-FSP-LICENCE-NECESSITY confirm-A: counsel-confirmation is no longer a gate on Saskia's KI appointment.
- **Composition unchanged.** Saskia holds the FAIS KI seat **in addition to** her Head of Global Markets governance role; the FAIS KI is not a 7th human. The licence-day six (3 NEDs, CoSec, Compliance Lead, CRO) + Marc + audit firm composition in §3A is unchanged by this confirmation.
...
| FAIS Key Individual | Saskia (steady-state — confirmed by D-FSP-LICENCE-NECESSITY confirm-A, 2026-05-09; subject only to fit-and-proper file per §3C); Marc (interim) | Saskia (steady-state, post-fit-and-proper); Marc-interim until Gate (b) closes | FAIS Act 37 of 2002 s.8 + Determination of Fit and Proper Requirements 2017 |
