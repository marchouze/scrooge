...
asOf: 2026-05-11T05:51:50.727Z
decision-required: false
---

# Saskia — markets-readiness snapshot, 2026-05-11
...
**Headline:** 26 Saskia-owned obligations on the register (5 IN FORCE; 1 IN FLIGHT; 4 PARTIAL; 12 PLANNED; 2 PRE-LICENCE) · markets bench 2/1 handlers (Kai pending) · 0 trades booked · M1 decision / design pending, CDM module scaffolded.
...
|---|---|---|
| Kai | 2 | `kai:m1-cdm-typescript-bindings`, `kai:pre-trade-gateway-aggregator` |
