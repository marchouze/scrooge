...
asOf: 2026-06-04T05:58:13.738Z
decision-required: false
---

# Helena — risk-appetite watch, 2026-06-04
...
**Headline:** 14 appetite lines · 9 measured · 0 unmeasured (substrate gap) · 0 open breaches (0 tier-1, 0 tier-2) · 29 days since RAS approval.
...
| CET1 buffer over PA min | capital | tier-1 | RAS §B3 | green | Live capital position derived from CapitalEvent events: capital R300 000 000, headroom R263 325 000, CET1 ratio 71.40%. TICR = R36 675 000. RWA: live positions (9 trade events; D-RWA-LIVE-POSITIONS-PROJECTION-V1). Status: green. |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbhhxsPiEK1uMVr8186Ws"})._
