...
//
// CLI runner for `recon:goal-loop-run-lifecycle`.
// Called by `bun run recon:goal-loop-run-lifecycle` and from the ci script.
//
// Authority: D-AUTONOMY-RUN-LIFECYCLE-INSTRUMENTATION; D-QUEUE-CLOSEOUT-2026-06-10.

import { logger } from "../composition";
import { run } from "./goal-loop-run-lifecycle";
