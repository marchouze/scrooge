...
function buildScenarioA(): Event[] {
  ...
  events.push(
    rawSlice2Event(
      "BeneficialOwnerResolved",
      {
        counterpartyId: cp,
        beneficialOwners: [
          { name: "Meridian Capital Holdings SA (Pty) Ltd", ownershipPct: 60, verified: true },
          { name: "Vantage Investment Trust", ownershipPct: 40, verified: true },
        ],
        resolvedBy: REVIEWER_NIKO,
        evidenceRef: "BO-RESOLUTION-MC-2026-001",
      },
  ...
  events.push(
    rawSlice2Event(
      "SanctionsClearancePassed",
      {
        ...
        result: "clear",
        screenedAt: "2026-03-11T08:30:00Z",
      },
  ...
  events.push(
    rawSlice2Event(
      "FatcaCrsClassified",
      {
        ...
        crsResidency: "ZA",
        selfCertRef: "FATCA-CRS-MC-2026-001",
        classifiedBy: REVIEWER_NIKO,
      },
  ...
  events.push(
    rawSlice2Event(
      ...
      {
        counterpartyId: cp,
        consentRef: "POPIA-CONSENT-MC-2026-001",
  ...
  events.push(
    rawSlice2Event(
      "CreditAssessmentCompleted",
      {
        ...
        assessmentRef: "CREDIT-MC-2026-001",
  ...
  events.push(
    rawSlice2Event(
      "AccountsSetupCompleted",
      {
        counterpartyId: cp,
        accountsCreated: [
          { accountId: "ACC-MC-ZAR-001", currency: "ZAR", purpose: "settlement" },
          { accountId: "ACC-MC-ZAR-002", currency: "ZAR", purpose: "margin" },
        ],
        configuredBy: REVIEWER_NIKO,
        setupRef: "ACC-SETUP-MC-2026-001",
      },
...
function buildScenarioC(): Event[] {
  ...
  events.push(
    rawSlice2Event(
      "BeneficialOwnerResolved",
      {
        counterpartyId: cp,
        beneficialOwners: [
          { name: "Southern Cross Holdings Ltd", ownershipPct: 100, verified: true },
        ],
        resolvedBy: REVIEWER_NIKO,
        evidenceRef: "BO-RESOLUTION-SC-2026-001",
      },
  ...
  events.push(
    rawSlice2Event(
      "SanctionsClearancePassed",
      {
        ...
        result: "clear",
        screenedAt: "2026-03-15T08:00:00Z",
      },
  ...
  events.push(
    rawSlice2Event(
      "FatcaCrsClassified",
      {
        ...
        fatcaStatus: "non-us-person",
        crsResidency: "ZA",
        selfCertRef: "FATCA-CRS-SC-2026-001",
        classifiedBy: REVIEWER_NIKO,
      },
  ...
  events.push(
    rawSlice2Event(
      ...
      {
        counterpartyId: cp,
        consentRef: "POPIA-CONSENT-SC-2026-001",
  ...
  events.push(
    rawSlice2Event(
      "CreditAssessmentCompleted",
      {
        ...
        assessedBy: REVIEWER_NIKO,
        assessmentRef: "CREDIT-SC-2026-001",
  ...
  events.push(
    rawSlice2Event(
      ...
      {
        counterpartyId: cp,
        accountsCreated: [{ accountId: "ACC-SC-ZAR-001", currency: "ZAR", purpose: "settlement" }],
        configuredBy: REVIEWER_NIKO,
        setupRef: "ACC-SETUP-SC-2026-001",
      },
