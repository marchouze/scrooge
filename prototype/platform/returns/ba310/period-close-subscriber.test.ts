// platform/returns/ba310/period-close-subscriber.test.ts
//
// M3 Slice 5 — Unit tests for the AccountingPeriodClosed → BA 310
...
describe("BA310 period-close subscriber — zero-position baseline", () => {
  it("generates a BA 310 with zero capital for empty event store", () => {
    ...
    expect(result.ba310Output.meta.form).toBe("BA 310");
