...
asOf: 2026-06-07T06:53:41.272Z
decision-required: false
---

# Eitan — liquidity snapshot, 2026-06-07
...
| Prior `LiquiditySnapshot` (this agent) | 10 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CboTbeVdmQd9EqhBzFePt"})._
