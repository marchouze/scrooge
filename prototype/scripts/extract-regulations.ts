...
const MANIFEST: ManifestEntry[] = [
  ...
  // Co-operative Banks / CFI guidance notes & directives removed 2026-06-20:
  // out of applicable scope for a commercial bank licensed under the Banks Act
  // 94 of 1990 (these govern co-operative banks / CFIs under the Co-operative
  // Banks Act). See D-COOP-BANKS-REGS-OUT-OF-SCOPE.
  ...
  // ── BCBS — breadth standards (beyond the Pillar-1 spine) ───────────────────
  {
    instrumentId: "BCBS-SCO",
    sourcePath: "BCBS/source-docs/sco-structured.json",
    title: "Basel Framework — SCO (Scope and definitions)",
    issuingBody: "BCBS",
    instrumentType: "guidance",
    jurisdiction: "INTL",
    publicationDate: "2019-12-15",
  ...
  {
    instrumentId: "BCBS-RBC",
    sourcePath: "BCBS/source-docs/rbc-structured.json",
    title: "Basel Framework — RBC (Risk-based capital requirements)",
    issuingBody: "BCBS",
    instrumentType: "guidance",
    jurisdiction: "INTL",
    publicationDate: "2019-12-15",
  ...
  {
    instrumentId: "BCBS-SRP",
    sourcePath: "BCBS/source-docs/srp-structured.json",
    title: "Basel Framework — SRP (Supervisory review process)",
    issuingBody: "BCBS",
    instrumentType: "guidance",
    jurisdiction: "INTL",
    publicationDate: "2019-12-15",
  ...
  {
    instrumentId: "BCBS-DIS",
    sourcePath: "BCBS/source-docs/dis-structured.json",
    title: "Basel Framework — DIS (Disclosure requirements)",
    issuingBody: "BCBS",
    instrumentType: "guidance",
    jurisdiction: "INTL",
    publicationDate: "2019-12-15",
  ...
  {
    instrumentId: "BCBS-BCP",
    sourcePath: "BCBS/source-docs/bcp-structured.json",
    title: "Basel Framework — BCP (Core Principles for effective banking supervision)",
    issuingBody: "BCBS",
    instrumentType: "guidance",
    jurisdiction: "INTL",
    publicationDate: "2019-12-15",
  ...
  {
    instrumentId: "BCBS-MGN",
    sourcePath: "BCBS/source-docs/mgn-structured.json",
    title: "Basel Framework — MGN (Margin requirements)",
    issuingBody: "BCBS",
    instrumentType: "guidance",
    jurisdiction: "INTL",
    publicationDate: "2019-12-15",
