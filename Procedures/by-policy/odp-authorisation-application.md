...
| 4 | Prepare capital-adequacy evidence: ICAAP summary, CET1 ratio, minimum operational capital per CS 1/2018 §3; reference the Prudential Authority banking-licence capital conditions | `agent` (Camille) | `@platform/projections/capital-ratio-monitoring` | Capital evidence cross-references the bank's existing PA capital return (BA 700) once that filing has commenced. |
