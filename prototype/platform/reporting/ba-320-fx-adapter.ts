 ...
 *
 * Each FxPositionResult maps to one FxPositionRow per the BA 310 schema:
 *   - currency: the non-functional currency (base currency of the pair)
 *   - netPositionFunctionalMinor: net position in ZAR minor units
 *
 * The functional currency (ZAR) leg is excluded by the BA 310 generator
...
/**
 * Convenience function: generate a BA 310-ready FX section note string
