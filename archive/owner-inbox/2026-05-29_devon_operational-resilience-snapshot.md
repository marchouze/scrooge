...
asOf: 2026-05-29T10:20:54.326Z
decision-required: false
---

# Devon — operational-resilience snapshot, 2026-05-29
...
**Headline:** 6-seat engineering bench · 29 runtime handlers live · 0 incidents (last 7d) · 64 upstream snapshots observed · 1 substrate exception on register.
...
|---|---|---|
| Atlas — `SubstrateStateSnapshot` | weekly | 52 |
| Anya — `DataProjectionSnapshot` | daily | 9 |
