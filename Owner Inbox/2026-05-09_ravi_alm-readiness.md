...
asOf: 2026-05-09T07:26:30.665Z
decision-required: false
---

# Ravi — ALM readiness, 2026-05-09
...
**Headline:** 9 ALM pipelines tracked · readiness 0 ready / 1 drafting / 8 specified / 0 not-yet-specified · 7 Ravi-owned obligations indexed (1 PARTIAL / drafting) · 0 ALM-domain events (last 7d).

## Eitan's latest snapshot

Latest `LiquiditySnapshot` event: 2026-05-08T08:14:24.850Z
...
| ORG-MK-08 | Currency and Exchanges Manual (Excon) | Eitan + Zara | PARTIAL |
...
| `CollateralUpdated` | 0 |
| `FundingDrawnDown` | 0 |
| Prior `ALMReadinessSnapshot` (this agent) | 0 |
