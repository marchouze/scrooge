...
- **Live correspondent bank channel connectivity** — Interface + stubs defined (W2.1 wave-2, D-TREASURER-WAVE2-SUBSTRATE); wire-up pending correspondent/sponsor-bank selection at licence-application moment. ISO 20022 pacs.008/009/002 + camt.053/054 envelope types defined. Concrete adapter wraps SWIFT gpi/CBPR+ per correspondent's CSP. Owner: Tomas (domain) + Atlas (substrate). Target: licence-day; pre-licence end-to-end rehearsal under Saskia's go-live readiness gate.
...
| v1.4 | 2026-06-11 | Tomas (via Scrooge) | W2.1 wave-2: correspondent-connector interface + stubs defined (D-TREASURER-WAVE2-SUBSTRATE). ISO 20022 pacs.008/009/002 + camt.053/054 envelope types defined. §16 correspondent bank channel gap updated from "synthetic only" to "interface+stubs defined". |
