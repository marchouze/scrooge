...
asOf: 2026-06-14T04:30:29.810Z
decision-required: false
---

# Helena — risk-appetite watch, 2026-06-14
...
**Headline:** 17 appetite lines · 11 measured · 0 unmeasured (substrate gap) · 0 open breaches (0 tier-1, 0 tier-2) · 39 days since RAS approval.

## Appetite-line states

| Line | Category | Tier | RAS § | Status | Note |
|---|---|---|---|---|---|
| LCR buffer | liquidity | tier-1 | RAS §B3 | green | Build-phase: no positions in store → no-outflow construction; RAS §B3 LCR appetite line resolves to green-with-substrate-gap. Substrate gaps: 3 class(es). Source: Ravi (Treasury and ALM engineer, engineering) ALM-positions projection T+30. |
| NSFR buffer | liquidity | tier-1 | RAS §B3 | green | NSFR T+30 = ∞ (ASF R300,000,000, RSF R0). RAS §B3 thresholds: green ≥115% / amber 108-115% / red <108% / critical <103%. Substrate gaps: 3 class(es). |
| CET1 buffer over PA min | capital | tier-1 | RAS §B3 | green | Live capital position derived from CapitalEvent events: capital R300 000 000, headroom R263 325 000, CET1 ratio 396762.52%. TICR = R36 675 000. RWA: live positions (2 trade events; D-RWA-LIVE-POSITIONS-PROJECTION-V1). Status: green. |
...
| Market-risk 1-day 99% VaR ceiling (MR-1-FX) | market | tier-2 | RAS §B4 | n/a-build-phase | No book or portfolio in build phase; line activates at commencement of trading. |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cc2XLjBkh54HN9VPKtZnX"})._
