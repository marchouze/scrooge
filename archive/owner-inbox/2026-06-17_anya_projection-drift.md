...
asOf: 2026-06-17T03:17:22.565Z
decision-required: false
---

# Anya — projection drift, 2026-06-17
...
| Owner Inbox deliverables | 796 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-17T03:00:35.164Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cc87C4AFDcuVTtNZRfKo8"})._
