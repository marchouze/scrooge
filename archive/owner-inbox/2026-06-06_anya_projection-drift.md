...
asOf: 2026-06-06T07:53:58.872Z
decision-required: false
---

# Anya — projection drift, 2026-06-06
...
| Owner Inbox deliverables | 632 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-06T07:53:57.015Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbmePMztLJD6oLyhN3eXE"})._
