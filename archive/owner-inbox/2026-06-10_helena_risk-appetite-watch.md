...
# Helena — risk-appetite watch, 2026-06-10
...
**Headline:** 16 appetite lines · 9 measured · 1 unmeasured (substrate gap) · 0 open breaches (0 tier-1, 0 tier-2) · 35 days since RAS approval.
...
| CET1 buffer over PA min | capital | tier-1 | RAS §B3 | green | Live capital position derived from CapitalEvent events: capital R300 000 000, headroom R263 325 000, CET1 ratio 369.23%. TICR = R36 675 000. RWA: live positions (82 trade events; D-RWA-LIVE-POSITIONS-PROJECTION-V1). Status: green. |
