...
const ROUTES: readonly RouteEntry[] = [
  ...
  },
  {
    ...
    wiredMarker: "",
    reason:
      "No V2 capital-metrics projection present on origin/main (brief-cited projections/ba700-v2.ts does not exist in-tree).",
  },
  {
    ...
    wiredMarker: "",
    reason:
      "Phase 3b (#1383) added V2 money-market GL/BA-300 events but no V2 projection matching the LCR/NSFR snapshot shape the treasury route consumes.",
  },
  {
    ...
    wiredMarker: "",
    reason:
      "Brief-cited #1379 V1+V2 dual-read is not present on origin/main — getMarketRiskMeasure folds a single MarketRiskMeasureComputed event with no V2 branch.",
  },
  {
    ...
    wiredMarker: "",
    reason:
      "No route-level V2 BA-700/BA-320 projection found on origin/main to swap in at the route boundary (brief-cited #1378 projections not located).",
  },
];
