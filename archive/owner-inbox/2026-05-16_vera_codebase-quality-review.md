---
title: Codebase quality review — 2026-05-16
author: Vera (Internal audit engineer, third-line)
date: 2026-05-16
summary: 3 recons run; 0 fail / 0 warn / 2 info findings across 1065 assertions.
decision-required: false
authority: GOV-FRAMEWORK-CAE-INDEPENDENCE
---

# Codebase quality review — 2026-05-16
...
|---|---|---|---|---|
| code-quality:any-density | 532 | 0 | 0 | 1 |
| code-quality:swallowed-errors | 532 | 0 | 0 | 0 |
...
- `code-quality:any-density` — 4 `any` occurrences across 532 files scanned (threshold 3/file).
- `code-quality:legacy-bypass-watch` — LEGACY_PRE_A1_EVENT_TYPES at baseline (217 entries, as of 2026-05-14). No drift.
