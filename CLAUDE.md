...
- **Phase 4 gated** on `D-RMS-PHASE-4` (pending spec approval; `D-RMS-PHASE-4-ARCHIVE-SCOPE` CEO-approved 2026-05-17 — full move, all four directories): legacy `Owner Inbox/`, `Owner Inbox/actioned/`, `Team Inbox/`, `Team Inbox/actioned/` → `archive/`; dashboard legacy parser removed; RMS registers sole canonical. Spec: [`Owner Inbox/2026-05-17_owen-atlas_rms-phase-4-spec.md`](Owner%20Inbox/2026-05-17_owen-atlas_rms-phase-4-spec.md).
