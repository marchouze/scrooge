...
- **Issues-and-actions tracker** — ✅ **closed 2026-05-31.** `AuditIssueOpened`/`AuditIssueClosed` events, `buildOpenIssues()` projection, `vera:issues-tracker` handler, and dashboard integration all landed in a single PR. Open issues register is now event-sourced and visible on the audit dashboard.
...
| v1.3 | 2026-05-31 | Vera (Internal audit / continuous-assurance engineer, via Scrooge) | Issues-and-actions tracker substrate landed; §16 gap closed. |
