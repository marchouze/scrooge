...
| Liquidity Risk Management Policy | [`intraday-liquidity-funding.md`](by-policy/intraday-liquidity-funding.md) (PROC-RISK-ILF-01 — intraday liquidity position monitoring; BCBS seven metrics; correspondent bank funding facility; ALCO and ILAAP integration) | Eitan (Treasurer) · Ravi (ALM quant engineer) · Helena (CRO, governance) | **POPULATED** |
| IRRBB Policy | [`irrbb-measurement.md`](by-policy/irrbb-measurement.md) (PROC-RISK-IRRBB-01 — monthly NII/EVE; six BCBS shock scenarios; PA outlier test; ALCO governance; ILAAP chapter) | Helena (CRO, governance) · Eitan (Treasurer) · Ravi (ALM quant engineer) | **POPULATED** |
...
| Recovery and Resolution Planning Policy v1 | [`recovery-resolution-plan.md`](by-policy/recovery-resolution-plan.md) (PROC-RRP-01 — continuous recovery indicator monitoring (CET1/LCR/NSFR/NSFP/market-access proxy); RMC convening on breach; pre-assessed options inventory (8 options); Amber/Red/Critical escalation matrix; annual plan update + SARB submission; five typed events: `RecoveryIndicatorBreached`, `RecoveryManagementCommitteeConvened`, `RecoveryOptionSelected`, `RecoveryPlanUpdated`, `SarbRecoveryPlanAcknowledged`; Banks Act ss.68–71; PA D1/2015) | Devon (Chief Operating Officer, governance) · Helena (Chief Risk Officer, governance) | **POPULATED** |
...
| RMCP / Sanctions / FIC | [`fic-submission-cycle.md`](by-policy/fic-submission-cycle.md) (PROC-FC-01 — FIC Act CTR/STR/sanctions submission cycle; RMCP review; goAML portal; tipping-off controls; Vera overnight recon gate) | Triple-hatted compliance lead (MLRO + FIC CO + IO) — Zara (governance) + Mira (engineering) | **POPULATED** |
...
| Policy | Procedure | Owner | Status |
|---|---|---|---|
| Information Security Policy | [`access-provisioning.md`](by-policy/access-provisioning.md) (PROC-IS-AP-01 — joiner/mover/leaver lifecycle; RBAC; privileged access dual-approval; quarterly privileged + annual standard review; HSM custodian ceremony; `AccessGranted` / `AccessRevoked` / `AccessReviewCompleted` events; orphaned-account detection recon) | Rashida (Chief Information Security Officer, governance) · Devon (Chief Operating Officer, governance) | **POPULATED** |
| Information Security Policy | [`key-rotation.md`](by-policy/key-rotation.md) (PROC-IS-KR-01 — cryptographic key lifecycle: HSM root/signing/encryption/API key rotation on schedule or on-demand; dual-control ceremony; `KeyRotated` event chain; key-rotation register) | Rashida (Chief Information Security Officer, governance) · Devon (Chief Operating Officer) | **POPULATED** |
| Cyber Resilience Policy | [`incident-response.md`](by-policy/incident-response.md) (IR command) | Senna + Devon + Iris + Zara | **POPULATED** |
| Cyber Resilience Policy | [`cyber-incident-classification.md`](by-policy/cyber-incident-classification.md) (PROC-IS-CIC-01 — P1/P2/P3/P4 tier matrix; IBS-exposure dimension; PA/FSCA/IR notification matrix; regulator SLAs) | Rashida (Chief Information Security Officer, governance) · Iris (Information Officer, governance) | **POPULATED** |
| Vulnerability Management | [`patch-cadence.md`](by-policy/patch-cadence.md) (PROC-IS-PC-01 — CVSS-based SLA matrix with IBS-exposure uplift; three vulnerability-signal sources; change-management integration) | Rashida (Chief Information Security Officer, governance) · Devon (Chief Operating Officer, governance) | **POPULATED** |
...
| Secure SDLC Policy | [`threat-model-review.md`](by-policy/threat-model-review.md) (PROC-SDLC-TM-01 — STRIDE/DREAD; bank-context amplification; Secure SDLC gate; annual refresh) | Rashida (Chief Information Security Officer, governance) · Senna (Security engineer, engineering) | **POPULATED** |

## Operations & technology

| Policy | Procedure | Owner | Status |
|---|---|---|---|
| Outsourcing & Third-Party Risk | [`outsourcing-due-diligence.md`](by-policy/outsourcing-due-diligence.md) (PROC-OPS-OUTS-01 — pre-engagement; 11-step DD cycle; materiality-based approval routing; Directive 3 trigger) | Devon (COO, governance) · Rashida (Chief Information Security Officer, governance) · Iris (Information Officer, governance) · Imani · Mira | **POPULATED** |
| Outsourcing & Third-Party Risk | [`directive-3-pa-notification.md`](by-policy/directive-3-pa-notification.md) (PROC-OPS-D3-01 — PA notification of cloud/offshoring arrangements; Directive 3 §6 minimum-content; cyber attestation; POPIA s.72) | Devon (Chief Operating Officer, governance) · Owen (Company Secretary, governance) · Imani · Rashida (Chief Information Security Officer, governance) · Senna (Security engineer, engineering) · Iris (Information Officer, governance) | **POPULATED** |
| Cloud Computing | [`cloud-residency-attestation.md`](by-policy/cloud-residency-attestation.md) (PROC-IS-CRA-01 — annual cloud service inventory; data classification mapping; POPIA s.72 transfer assessment; PA Joint Standard 2 attestation; CEO sign-off) | Devon (Chief Operating Officer) · Senna (information security & cloud engineer) | **POPULATED** |
| BCP / DR | [`dr-test-execution.md`](by-policy/dr-test-execution.md) (PROC-OR-DR-01 — annual full DR test + semi-annual component tests; five IBS with explicit RTO/RPO targets; failover → IBS verification → failback → post-test report) | Devon (COO, governance) · Senna (Security engineer, engineering) | **POPULATED** |
...
| Payments Policy | [`correspondent-cut-off.md`](by-policy/correspondent-cut-off.md) (PROC-PAY-SCO-01 — internal cut-off discipline for NPS settlement morning/afternoon cycles; correspondent processing buffer; calendar engine; `CutOffCheckPassed` / `CutOffDeferred` events) | Tomas (payments engineer) | **POPULATED** |
...
| Sponsor-Bank Operating Policy · Payments Policy | [`nostro-management.md`](by-policy/nostro-management.md) (PROC-PAY-NM-01 — opening balance feed → PROC-RISK-ILF-01 Step 1; intraday projection; EoD reconciliation against correspondent statement; account maintenance; `NostroOpeningBalance` / `NostroEoDReconciliationComplete` events) | Tomas (payments engineer) · Eitan (Treasurer) | **POPULATED** |
| SWIFT CSP · Information Security & IT Governance Policy v1 · Secure SDLC Policy v1 | [`swift-csp-attestation.md`](by-policy/swift-csp-attestation.md) (PROC-SWIFT-CSP-01 — annual SWIFT CSP self-attestation cycle; system inventory; per-control assessment; evidence vault; independent assessment; KYC-SA portal submission; gap register; five typed events; Vera recon assertions) | Senna (Security & Infrastructure engineer) · Tomas (Payments & settlement engineer) | **POPULATED** |
...
| Capital Management | [`capital-instrument-issuance.md`](by-policy/capital-instrument-issuance.md) (PROC-CAP-CII-01 — CET1 / AT1 / Tier 2 issuance lifecycle; Board auth gate; SARB no-objection gate; PONV clause; STRATE settlement) | Camille (CFO, governance) · Eitan (Treasurer) | **POPULATED** |
...
| Accounting Policies (IFRS) | [`balance-sheet-substantiation.md`](by-policy/balance-sheet-substantiation.md) (PROC-FIN-BSS-01 — monthly per-account source-event trace + CFO sign-off + `BalanceSheetSubstantiationCompleted` event) | Bea (Camille sign-off) | **POPULATED** |
...
| Regulatory Reporting Policy · Financial Reporting Policy · Pillar 3 Disclosure Policy | [`pillar-3-disclosure-cycle.md`](by-policy/pillar-3-disclosure-cycle.md) (PROC-P3-01 — semi-annual Pillar 3 public disclosure: balance-sheet + BA-return pre-work gates; nine BCBS / Reg 43 tables (CCA, CC1, CC2, OV1, LR1, LIQA, CR1, CR2, MR1); CEO + CFO sign-off; SARB submission; `Pillar3DisclosurePublished` event; restatement path) | Camille (Chief Financial Officer, governance) · Owen (Company Secretary, governance) | **POPULATED** |
...
| Trade Confirmation and Affirmation Policy v1 · Trading Mandate v1 · Payments and Settlement Policy v1 | [`trade-confirmation-affirmation.md`](by-policy/trade-confirmation-affirmation.md) (PROC-MK-CONF-01 — JSE-listed bonds, equities, and exchange-traded products; JSE-electronic matched confirmation + bilateral voice-trade confirmation; affirmation monitoring; T+0-close unmatched detection; dispute escalation T+1-noon → Devon + Helena; settlement gate: `TradeConfirmed` required before STRATE instructions; `LateAffirmationReceived` path; five typed events; Vera zero-exception recon) | Saskia (Head of Global Markets) · Tomas (Payments & settlement engineer, engineering) | **POPULATED** |
...
| Excon Compliance Policy | [`finsurv-reporting.md`](by-policy/finsurv-reporting.md) (PROC-FINSURV-BOP-01 — SARB FinSurv per-transaction BoP-category reporting; build-phase scaffold; ORG-FX-FIN-01..14 class→obligation→Currency-&-Exchanges-Manual-section map; `deriveBopCategoryTag` hook (BOPCUS code null pending counsel; Wave-2 fail-closed); optional `bopCategory` tag on `FilFxSettlementConfirmed` / `FilNdfFixingObserved`; FinSurv BoP reporting read-side fold; live per-transaction submission a tracked licence-day gap) | Mira (Compliance / RegTech engineer, engineering) · Zara (CCO, governance) | **POPULATED** |
| Trade Reporting Policy v1 · Securities Financing Policy v1 · Regulatory Reporting Policy v1 | [`sftr-trade-reporting.md`](by-policy/sftr-trade-reporting.md) (PROC-MK-SFTR-01 — repo / reverse-repo / SFT reporting to JSE TRR; UTI assignment; T+1 initial report; daily valuation update by 09:00; modification + termination lifecycle; three retry/fallback paths; nine reconciliation events; six Vera assertions; three PLANNED substrate gaps) | Mira (Compliance / RegTech engineer, compliance) · Tomas (Payments & settlement engineer, engineering) | **POPULATED** |
...
| Insider Trading / PA Dealing | [`pa-dealing-pre-clearance.md`](by-policy/pa-dealing-pre-clearance.md) (PROC-COND-PAD-01 — designated-person register; pre-clearance 24h SLA; trading window; FMCA Part 8; annual certification; activates at licence-day) | Owen (Company Secretary, governance) · Zara (Chief Compliance Officer) | **POPULATED** |
...
| Policy | Procedure | Owner | Status |
|---|---|---|---|
| AML / CFT Policy v1 | [`kyc-continuous.md`](financial-crime/kyc-continuous.md) (PROC-FC-CKKYC-01 — continuous KYC re-evaluation between formal refresh cycles; signal-triggered; counterpart to by-policy `kyc-continuous.md`) | Zara (Chief Compliance Officer) · Mira (Regulatory intelligence engineer, compliance) | **POPULATED** |
| AML / CFT Policy v1 | [`pep-handling.md`](financial-crime/pep-handling.md) (PROC-FC-PEP-01 — enhanced due diligence for politically exposed persons) | Zara (Chief Compliance Officer) · Mira (Regulatory intelligence engineer, compliance) | **POPULATED** |
| AML / CFT Policy v1 | [`ubo-resolution.md`](financial-crime/ubo-resolution.md) (PROC-FC-UBO-01 — recursive beneficial-ownership identification per FIC Act s.21(1)(b)) | Zara (Chief Compliance Officer) · Mira (Regulatory intelligence engineer, compliance) | **POPULATED** |

### Markets

| Policy | Procedure | Owner | Status |
|---|---|---|---|
| Counterparty Credit Policy (planned) | [`corporate-issuer-inclusion-list.md`](markets/corporate-issuer-inclusion-list.md) (PROC-MK-CIL-01 — corporate issuer inclusion/exclusion from approved-counterparty list) | Saskia (Head of Global Markets) · Helena (Chief Risk Officer, governance) | **POPULATED** |
| Trading Mandate v1 | [`dealer-mandate-breach-handling.md`](markets/dealer-mandate-breach-handling.md) (PROC-MK-MBH-01 — dealer mandate limit breach detection, triage, and resolution) | Saskia (Head of Global Markets) · Helena (Chief Risk Officer, governance) | **POPULATED** |
| Trading Mandate v1 | [`dealer-mandate-issuance.md`](markets/dealer-mandate-issuance.md) (PROC-MK-MDI-01 — dealer mandate issuance, review, and revocation) | Saskia (Head of Global Markets) · Helena (Chief Risk Officer, governance) | **POPULATED** |
| D-MARKETS-SCHEMA-FOUNDATION | [`franchise-posture-refresh.md`](markets/franchise-posture-refresh.md) (PROC-MK-FPR-01 — quarterly markets franchise posture refresh) | Saskia (Head of Global Markets) | **POPULATED** |
| Trading Mandate v1 | [`fx-forwards-trade-lifecycle.md`](markets/fx-forwards-trade-lifecycle.md) (PROC-MK-FXFL-01 — FX forwards trade lifecycle: booking, MtM revaluation, fixing, settlement) | Saskia (Head of Global Markets) | **POPULATED** |
| D-MARKETS-SCHEMA-FOUNDATION + Banks Act 94 s.11 | [`pre-licence-go-live-gate.md`](markets/pre-licence-go-live-gate.md) (PROC-MK-PLG-01 — terminal pre-licence go-live readiness gate; 5 NPA + 6 OPS conditions + regulatory approvals; CEO `GoLiveReadinessConfirmed` event) | Saskia (Head of Global Markets) · Zara (Chief Compliance Officer, governance) · Devon (Chief Operating Officer, governance) | **POPULATED** |
| Best Execution Policy (planned) · Conduct Policy (planned) · Credit Risk Policy v1 | [`pre-trade-conduct-gate.md`](markets/pre-trade-conduct-gate.md) (PROC-MK-PCG-01 — pre-trade conduct and suitability gate for FX spot trades) | Saskia (Head of Global Markets) · Mira (Compliance / RegTech engineer, compliance) · Zara (MLRO, governance) | **POPULATED** |
| Client Onboarding Policy (planned) | [`soft-franchise-pipeline.md`](markets/soft-franchise-pipeline.md) (PROC-MK-SFP-01 — soft-franchise pipeline management; institutional relationship onboarding stage) | Saskia (Head of Global Markets) · Niko (Client Lifecycle Manager, paused build-phase) · Imani (Chief Legal Counsel / Legal-entity & clause-library engineer) | **POPULATED** |

### Operations

| Policy | Procedure | Owner | Status |
|---|---|---|---|
| Valuation Policy v1 §3.1 · Market Risk Policy v1 (controlled-launch envelope) · Trading Mandate v1 §2.5 | [`sarb-fixing-as-fx-spot-ipv-source.md`](operations/sarb-fixing-as-fx-spot-ipv-source.md) (PROC-OPS-SARB-FIX-IPV-01 — SARB ZAR Fixing as authorised FX-spot IPV source for controlled-launch) | Saskia (Head of Global Markets) | **POPULATED** |
