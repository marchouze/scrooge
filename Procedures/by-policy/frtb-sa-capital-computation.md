...
| `ORG-PR-60` | SA/IMA market-risk capital reporting to PA via the **BA 320** market-risk return (SA, or IMA once PA-approved). This procedure produces the canonical SA total that feeds BA 320. |
