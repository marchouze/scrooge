...
recordDecision({
  ...
  category: "risk",
  recommendation: "Approve Neon Postgres as the shared event store for the build phase under exception TM-NEON-EVENT-STORE-001, pending §5.1 role downgrade and §5.2 IP allowlist before any sensitive-data event flows.",
  rationale: "Senna's threat model (approved) identified two hardening conditions. Until those land, only non-sensitive events flow. The risk is accepted and tracked as a substrate gap.",
  sourceDocHashes: [],
