...
asOf: 2026-06-18T07:49:03.926Z
decision-required: false
---

# Rashida — cyber-resilience snapshot, 2026-06-18
...
**Headline:** 18 ORG-CY-* obligations indexed (0 citing Joint Standard 2 of 2024; 0 citing POPIA s.19–22) · 0 `SecurityIncidentRaised` events in the last 7 days · 1 threat-model gate decision.
...
| Event | Count |
|---|---|
| Senna `SecuritySubstrateSnapshot` | 1 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CcAMiccbhKvc4PKYoN3oV"})._
