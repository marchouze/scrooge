// platform/reporting/ba-350-xml-adapter.ts
//
// Thin adapter that maps a typed `Ba350Output` to the generic
// `SarbXmlReportPayload` consumed by `xml-render.ts`. Slice 5.

import type { Ba350Output, Ba350LineItem } from "./ba-350-market-risk";
import type { SarbXmlReportPayload, SarbXmlSection } from "./xml-render";

export const BA_350_XSD_URI = "https://hoz.bank/xsd/ba-350/v0.1-rehearsal.xsd"; // [citation: TBC]
export const BA_350_NAMESPACE = "https://hoz.bank/ns/ba-350/v0.1";

function lineItem(it: Ba350LineItem): SarbXmlSection {
  return {
    LineId: it.lineId,
...
export function ba350ToXmlPayload(out: Ba350Output): SarbXmlReportPayload {
  ...
  return {
    formId: "BA350",
    formVersion: out.meta.formVersion,
    xsdUri: BA_350_XSD_URI,
    namespaceUri: BA_350_NAMESPACE,
    body,
  };
}

export const BA_350_REQUIRED_ELEMENTS: readonly string[] = [
  "Meta",
  "InterestRateGeneral",
  "InterestRateSpecific",
  "Equity",
