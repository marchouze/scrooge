...
**Phase 4 archive (in progress):** full move — all four directories (`Owner Inbox/`, `Owner Inbox/actioned/`, `Team Inbox/`, `Team Inbox/actioned/`) move to `archive/`; no directories stay in-tree; RMS registers are sole canonical. (D-RMS-PHASE-4-ARCHIVE-SCOPE, CEO-approved 2026-05-17. Top-level file move complete; `actioned/` and dashboard parser cutover gate on D-RMS-PHASE-4 decision approval.)
...
- **Phase 4 in-progress** — `D-RMS-PHASE-4` requested 2026-05-18 (decision pending CEO approval); `D-RMS-PHASE-4-ARCHIVE-SCOPE` CEO-approved 2026-05-17 — full move, all four directories. File archive underway: top-level `Owner Inbox/` and `Team Inbox/` files moved to `archive/`; `actioned/` subdirectories and dashboard legacy parser retirement gate on `D-RMS-PHASE-4` approval. RMS registers will become sole canonical at cutover. Spec: [`archive/owner-inbox/2026-05-17_owen-atlas_rms-phase-4-spec.md`](archive/owner-inbox/2026-05-17_owen-atlas_rms-phase-4-spec.md).
