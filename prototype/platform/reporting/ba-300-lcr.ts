...
// The `D-HQLA-COA-CLASSIFICATION` citation is now carried in every BA 110
...
//     Mira's WS-INSTRUMENT-ANALYSES lands the SARB BA 110 published-
...
//     lens that does not feed BA 110 directly; cited in the entries for
 ...
 * Citations: D-FINANCIAL-INSTRUMENT-ENTITY; BA-110-LCR; BCBS-LCR-2013.
 */
export interface AccountLiquidityClassification {
  ...
  /** Free-form sub-category label for line-by-line BA 110 render. */
...
/**
 * One line item on the BA 110 form. Lines compose into sections; sections
 ...
 * description from the SARB BA 110 schema. Per Marc's Q1 (rehearsal-grade
...
/**
 * Input-completeness meta block (G-3 from Eitan's BA 110 first end-to-end
 ...
 *   Eitan BA 110 first end-to-end validation
 *     (blake3:ea05a7cacda07b3f9432e0177cbb622160d4d3150ce5475068f0db10b61fcd1d);
...
/**
 * The full BA 110 generator output. The `lcrRatio` field is the ratio
...
/**
 * Bank-licence-bound entity short-ids that are in scope for BA 110. The
 ...
 * > BA-110 LCR (liquidity coverage) | cash-flow events
...
/**
 * Generate the BA 110 (LCR) projection.
 *
...
export function generateBa300Lcr(input: Ba300LcrGeneratorInput, opts?: Ba300LcrOpts): Ba300LcrOutput {
  ...
  // -------------------------------------------------------------------------
  // Input-completeness block (G-3 — Eitan BA 110 first end-to-end validation).
  //
