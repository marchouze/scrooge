...
date: 2026-05-13
summary: Standalone Credit Risk Policy covering counterparty credit risk (OTC derivatives + repo), issuer risk, settlement risk, concentration risk, large-exposure limits under the SA LEX regime, IFRS 9 ECL governance, wrong-way risk identification, and ISDA/GMRA netting as primary mitigation. Credit risk RWA uses Standardised Approach (SA) under Reg 23 per D-CREDIT-RISK-CAPITAL-APPROACH-V1. Closes obligations ORG-PR-09, ORG-PR-10, ORG-PR-16, ORG-PR-19 (partial), ORG-PR-40, ORG-PR-46 (PARTIAL — SA threshold sections), ORG-PR-31 (PARTIAL — SA implementation date). COMMENCEMENT-BIND.
...
- **Credit risk RWA — Standardised Approach.** For Pillar 1 capital purposes, the Bank computes credit risk RWA (BA 200) under the Standardised Approach (SA) for credit risk as set out in Regulation 23 of the Regulations Relating to Banks. No IRB approval has been sought or obtained; Regulation 23(10)(a) (prior SARB written approval to adopt IRB) is not applicable. Asset-class classification (retail, QRRE, corporate SME thresholds) follows the SA thresholds in D8/2023 (`ORG-PR-46`). The SA-CCR methodology (§3) produces the EAD input for CCR RWA under BA 325; the SA risk weights per Reg 23 produce the credit RWA on issuer exposures and other banking-book positions. The decision to use the SA and decline IRB at this stage is recorded as `D-CREDIT-RISK-CAPITAL-APPROACH-V1` (CEO-approved 2026-05-28, Capital Management Policy §1). The IFRS 9 ECL parameters (PD/LGD/EAD) used in §4 are provisioning parameters — they are point-in-time estimates for accounting purposes, not IRB-capital parameters.
...
- **Internal sub-limits below the LEX cap.** The Bank sets internal single-name exposure sub-limits below the 25% LEX cap, calibrated against the credit quality of the counterparty and the Bank's overall credit-risk appetite. The sub-limit schedule is maintained in [`Procedures/by-policy/credit-risk-limit-management.md`](../Procedures/by-policy/credit-risk-limit-management.md) (PROC-RISK-CLM-01, POPULATED 2026-05-20 under `D-CREDIT-LIMIT-ENGINE-BUILD`). Sub-limits are: investment-grade counterparties: up to 20% of eligible capital; sub-investment-grade counterparties (BRC-approved): up to 10% of eligible capital; sovereign and MDB counterparties (exempt category): monitoring only, no internal sub-limit applied at v0.
...
The credit-limit authority matrix is maintained in [`Procedures/by-policy/credit-risk-limit-management.md`](../Procedures/by-policy/credit-risk-limit-management.md) (PROC-RISK-CLM-01, POPULATED 2026-05-20 under `D-CREDIT-LIMIT-ENGINE-BUILD`). The authority structure at v0 is:
...
| `ORG-PR-46` | D8/2023 Threshold amounts — revised SA + IRB approaches for credit risk + liquidity + IRRBB | **IN FORCE — PARTIAL.** SA credit-risk threshold sections (§2 retail ≤R12.5m, §3 QRRE ≤R1.5m, §4–§5 corporate SME) — **closed** (SA asset-class classification uses these thresholds). IRB-specific sections (§6 AIRB cut-off, §7 AVC, §8 FIRB maturity) — **NOT_APPLICABLE** (SA elected per `D-CREDIT-RISK-CAPITAL-APPROACH-V1`). Liquidity/IRRBB threshold sections (§10–§11) — covered in Liquidity Risk Management Policy. | §1 (Credit risk RWA — Standardised Approach principle) |
| `ORG-PR-31` | G3/2023 Basel implementation dates — revised SA for credit risk + revised IRB approaches + FRTB + others | **IN FORCE — PARTIAL.** Revised SA for credit risk date — **closed.** Revised IRB approaches date — **NOT_APPLICABLE** (SA elected per `D-CREDIT-RISK-CAPITAL-APPROACH-V1`). | §1 (Credit risk RWA — Standardised Approach principle) |
...
|---|---|---|---|
| v1.2 | 2026-05-28 | Scrooge (Chief of Staff) on behalf of CEO | §1 — new "Credit risk RWA — Standardised Approach" principle added, clarifying: (a) Pillar 1 credit RWA computed under SA, not IRB; (b) Reg 23(10)(a) IRB pre-approval not applicable; (c) IFRS 9 ECL PD/LGD/EAD are provisioning parameters, not IRB capital parameters; (d) cites `D-CREDIT-RISK-CAPITAL-APPROACH-V1` (CEO-approved 2026-05-28) and Capital Management Policy §1 as the primary authority record. §9 obligations closure table — `ORG-PR-46` (PARTIAL — SA credit threshold sections closed; IRB sections NOT_APPLICABLE) and `ORG-PR-31` (PARTIAL — SA implementation date closed; IRB date NOT_APPLICABLE) rows added. Frontmatter summary updated accordingly. |
| v1.1 | 2026-05-20 | Helena (Chief Risk Officer, governance) | §2 (line 100, internal sub-limits) and §7 (Credit-Limit Authority Matrix) — `Procedures/by-policy/credit-risk-limit-management.md` reference upgraded from "(planned)" to live markdown link; the procedure is now POPULATED as PROC-RISK-CLM-01 under `D-CREDIT-LIMIT-ENGINE-BUILD` (CEO-approved 2026-05-20). No substantive policy change; the deferred operational matrix and sub-limit schedule are now operationalised in the linked procedure. |
