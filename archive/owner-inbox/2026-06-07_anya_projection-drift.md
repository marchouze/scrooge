...
asOf: 2026-06-07T05:58:23.295Z
decision-required: false
---

# Anya — projection drift, 2026-06-07
...
| Owner Inbox deliverables | 642 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-07T05:58:08.501Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CboPP2e4aBbjwc9STC31d"})._
