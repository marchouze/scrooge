...
| 3 | Cyber attestation (Joint Standard 2 of 2024 third-party extensions) | Senna (Security engineer) + Rashida (Chief Information Security Officer, governance) | `@platform/security/d3-cyber-attestation` (`PLANNED`) | Connectivity controls; key isolation; IR cooperation; supply chain |
