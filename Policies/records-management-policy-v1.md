...
citations:
  ...
  - "Financial Markets Act 19 of 2012 + JSE rules (trading communications recording)"
  - D-RMS-PHASE-1
...
- **Class 3a — Trading communications records (FMA + JSE rules; `ORG-MK-03`).** Voice and electronic communications of trading personnel relating to the reception, negotiation, execution, amendment, or cancellation of orders and trades are Class 3 records with their own capture controls: the Bank records the communications, retains them for the Class 3 floor (5 years, or the longer period the JSE rules or an FMA directive prescribe for the channel), and operates capture, storage, and retrieval controls that ensure completeness of the recordings and their availability for surveillance (Conduct of Business and TCF Policy §4.1) and regulatory inspection on demand. **Build-phase posture:** the Bank's trading personnel are autonomous agents (Principle 6) whose order and execution communications are typed events in the event store — the capture control is structural and the retention floor is enforced by this policy; no voice channel exists. The `CallRecordingMade` event (Conduct of Business and TCF Policy §3.4) is the capture record for any voice channel introduced at licence-day; introduction of any human voice-trading channel is a change-management event that activates voice-capture infrastructure **before** the channel goes live. Devon (Chief Operating Officer, governance) owns the capture infrastructure; Zara owns surveillance availability; completeness of capture is a Vera (internal audit engineer, engineering — third-line) annual audit item.
...
| `ORG-MK-03` | Record voice and electronic communications of trading personnel (FMA + JSE rules); retain for the prescribed period; available for surveillance and regulatory inspection; capture/storage/retrieval completeness controls | **IN FORCE** (event-channel capture is structural; voice channel activates at licence-day) — closed | §2 (Class 3a — Trading communications records) |
...
| v1.1 | 2026-06-10 | Zara (Chief Compliance Officer, governance) | Obligation-policy coverage gap triage (WS-OBLIGATION-POLICY-MAPPING, brief `brief:zara:triage-close-30-obligation-policy-coverage-gaps-:2026-06-10`). Added §2 Class 3a — Trading communications records (FMA + JSE rules voice/electronic communications recording, Class 3 retention floor, surveillance and inspection availability, capture-completeness controls; build-phase posture — agent communications are typed events, voice channel activates at licence-day with capture-before-go-live gate). Closes `ORG-MK-03`; added FMA + JSE frontmatter citation and `obligations:` frontmatter list so the graph IMPLEMENTED_BY fold derives the edge; extended §7 closure table. |
