...
asOf: 2026-05-14T05:54:29.395Z
decision-required: false
---

# Camille — financial-position snapshot, 2026-05-14
...
**Headline:** 61 Camille-owned obligations on the register (0 IN FORCE; 3 PARTIAL; 29 PLANNED) · finance bench 7/2 handlers · 0 closes / 0 BA returns / 0 AFS in build phase.
...
|---|---|---|
| Bea | 5 | `bea:goal-loop`, `bea:accounting-readiness`, `bea:fx-posting-engine`, `bea:m1-ifrs-classification-rules`, `bea:event-triage` |
