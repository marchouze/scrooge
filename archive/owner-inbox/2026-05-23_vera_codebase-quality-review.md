---
title: Codebase quality review — 2026-05-23
author: Vera (Internal audit engineer, third-line)
date: 2026-05-23
summary: 3 recons run; 0 fail / 3 warn / 2 info findings across 1997 assertions.
decision-required: false
authority: GOV-FRAMEWORK-CAE-INDEPENDENCE
---

# Codebase quality review — 2026-05-23
...
|---|---|---|---|---|
| code-quality:any-density | 998 | 0 | 0 | 1 |
| code-quality:swallowed-errors | 998 | 0 | 3 | 0 |
...
- `code-quality:any-density` — 6 `any` occurrences across 998 files scanned (threshold 3/file).
