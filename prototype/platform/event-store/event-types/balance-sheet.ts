...
//     close. Provides the supplemental BA 326 line items that individual
...
//
// Authority: BA 326; BCBS D396; Banks Act Reg 26A (NSFR); D-TREASURY-GAPS-WAVE1.
...
export const balanceSheetProjectedPayloadSchema = z.object({
  ...
  asOf: z.string().min(1),
  // ASF supplemental items (BA 326 Table 1) — complement individual event folds
  ...
  // RSF supplemental items (BA 326 Table 2) — complement HQLA + IBL folds
