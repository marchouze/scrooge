...
asOf: 2026-06-14T03:20:36.907Z
decision-required: false
---

# Anya — projection drift, 2026-06-14
...
| Owner Inbox deliverables | 769 |
| Team Inbox — open | 5 |
| Team Inbox — actioned | 59 |

## Cross-check vs dashboard cache

Cache asOf: `2026-06-14T03:01:06.529Z`
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011Cc2S1de2HKrGk9JqeNC6x"})._
