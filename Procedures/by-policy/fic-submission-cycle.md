...
**Owner:** Zara (CCO governance line; named MLRO + FIC Compliance Officer at the bank-as-engineer-substrate, ahead of the human licence-day appointment) · Mira (compliance / RegTech engineering line under Zara) · Iris (Information Officer)
...
**Zara (Chief Compliance Officer)** is the approval authority for changes to this procedure. Changes that affect the MLRO accountability structure, the CEO-MLRO independence rule, or the MLRO-alternate designation additionally require **Board AC approval** (via the interim Audit Forum chaired by Owen, until a Board AC is constituted). [citation: `ORG-FC-11`]
