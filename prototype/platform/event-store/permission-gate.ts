...
export const LEGACY_PRE_A1_EVENT_TYPES: ReadonlySet<string> = new Set([
  // Agent-runtime / governance core (A0 freeze §4)
  "AgentEscalation",
  "AgentDecision",
  ...
  // Model-risk pipeline (Nadia / Rohan)
  "ModelSubmitted",
  "ModelTierClassified",
  ...
  // Decisions / governance / observability
  "CeoDecision",
  "WorkstreamStarted",
  "WorkstreamCompleted",
  "AuditFinding",
  ...
  // Legal-entity tree (Imani / Owen)
  "LegalEntityRegistered",
  "LegalEntityChanged",
  "IntraGroupArrangementSigned",
  // Product lifecycle (NPA — Saskia / Kai / Owen / Helena / Camille / Zara / Vera / Anya)
  ...
  // RMS Phase 1 (Owen / Atlas)
  "AgentBriefIssued",
  "DecisionRequested",
  "Feedback",
  "BriefSuperseded",
  "RecordFiled",
  // Bank-account substrate (Tomas / Atlas / Bea)
  "BankAccountOpened",
