...
**Headline:** 96274 events across 165 types; 31/31 personas have operating specs; 134 runtime handlers registered; 715 files in /Owner Inbox/; 7 substrate gaps tracked.

## Event store

Path: `/Users/marc/.local/share/bank/event.db` · Total events: 96274

| Event type | Count | Earliest | Latest |
|---|---|---|---|
| `SubstrateAgentRunStarted` | 14569 | 2026-05-25 | 2026-06-10 |
| `SubstrateAgentRunCompleted` | 14396 | 2026-05-25 | 2026-06-10 |
| `BusDispatched` | 13058 | 2026-05-25 | 2026-06-10 |
| `ProvenanceReclassified` | 11478 | 2026-05-27 | 2026-05-29 |
| `LegacyFanoutShadowed` | 9455 | 2026-05-25 | 2026-06-10 |
| `DashboardProjectionRefreshed` | 2809 | 2026-05-25 | 2026-06-10 |
| `WorkstreamRegistered` | 2782 | 2026-05-07 | 2026-06-10 |
| `Decision` | 2740 | 2026-04-30 | 2026-06-11 |
| `RiskRaised` | 2448 | 2025-12-01 | 2026-06-02 |
| `RecordFiled` | 1964 | 2026-05-05 | 2026-06-10 |
| `CalculationPerformed` | 1677 | 2026-06-01 | 2026-06-10 |
| `ObligationAdopted` | 1394 | 2026-06-04 | 2026-06-09 |
| `SubstrateAlert` | 1316 | 2025-01-01 | 2026-06-11 |
| `ScheduledTrigger` | 1192 | 2026-05-25 | 2026-06-10 |
| `SubLedgerPostingEmitted` | 995 | 2026-06-01 | 2026-06-10 |
| `AgentGoalEvaluated` | 947 | 2026-05-25 | 2026-06-10 |
...
| `AgentRunCompleted` | 427 | 2026-05-10 | 2026-06-10 |
| `AgentGoalSelected` | 422 | 2026-05-25 | 2026-06-10 |
| `AgentRunStarted` | 414 | 2026-05-10 | 2026-06-10 |
| `AgentBriefIssued` | 408 | 2026-05-10 | 2026-06-10 |
| `BondPositionRevalued` | 390 | 2026-06-08 | 2026-06-10 |
| `SubstrateStateSnapshot` | 347 | 2026-05-07 | 2026-06-10 |
...
| `DailyPnLReportGenerated` | 160 | 2026-06-01 | 2026-06-10 |
...
| `WorkstreamCompleted` | 8 | 2026-05-28 | 2026-06-10 |
...
134 agent run handlers registered in `runtime/run.ts`. Each can be invoked locally via `bun run agent:<slug>` and on cron via `.github/workflows/agent-runtime-*.yml`.
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CbvH4fYdd1MRzRANjH6nT"})._
