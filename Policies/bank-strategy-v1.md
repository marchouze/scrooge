...
**Author:** Scrooge (Chief of Staff, orchestration) — synthesised from governance-seat inputs  
**Date:** 2026-05-22  
**Status:** DRAFT — PENDING CEO APPROVAL  
**Approval authority:** CEO (Marc, marc@tgv.co.za)  
**Substrate gap noted:** No Chief Strategy Officer (CSO) on roster; this document is authored by the Chief of Staff as synthesiser of governance-seat inputs. PAX to define the CSO role spec at the post-licence stage when strategic-planning headcount is warranted.
...
The bank operates a three-level capital target framework under the Risk Appetite Statement (D-RAS, Helena):
...
- **ICAAP:** Annual internal capital adequacy assessment, co-chaired by Camille (CFO) and Helena (CRO). First annual cycle: Q3 2027 (post first full year of trading).
...
- CEO (Marc, concurrent with the build phase);
...
The build phase ends at the **pre-licence go-live readiness gate**, co-owned by Saskia (Head of Global Markets), Devon (COO), and Rashida (CISO). Key substrate milestones en route:

| Milestone | Owner | Status |
|---|---|---|
| KYC onboarding substrate (D-KYC-ONBOARDING-BUILD) | Atlas / Mira | Complete (PR #532–536) |
| FX sales/trading frontend (D-FX-SALES-TRADING-FRONTEND) | Kai / Saskia | 7/8 slices complete |
| Trade lifecycle + IFRS chain (D-TRADE-LIFECYCLE-IFRS-CHAIN) | Kai / Bea | Complete (PRs #549–556) |
| Credit-limit engine (D-CREDIT-LIMIT-ENGINE-BUILD) | Rohan / Helena | Complete (PRs #611–624) |
| Market data substrate | Ravi / Anya | Complete (PRs #686–688) |
| RMS Phase 1–4 (records management substrate) | Atlas / Owen | Complete |
| LCR/NSFR measurement substrate | Ravi | Pending (before BRC Cycle 1) |
| CET1 RWA engine | Bea | Pending (before BRC Cycle 1) |
| Climate-risk substrate specification | Helena | Due 2026-07-15 |
| Pre-licence go-live readiness gate | Saskia · Devon · Rashida | Not started — pending substrate completion |
...
|---|---|---|
| CEO (Marc, interim Board) | Approves all material decisions; sole Board seat in build phase | Continuous |
| Board Risk Committee (BRC) | Reviews RAS, stress results, capital adequacy | Quarterly; first cycle 2026-08-04 |
| Audit Forum (Interim; Owen chair) | Receives internal audit findings; oversees CAE function | Periodic |
| ALCO (Eitan chair) | Reviews capital, liquidity, ALM, and treasury positions | Monthly |
...
- **Second line:** Helena (CRO), Zara (CCO), and their engineering counterparts (Rohan, Mira, Nadia) provide independent oversight, risk appetite monitoring, and compliance assurance.
- **Third line:** Thandiwe (CAE) and Vera (internal audit engineer) provide independent audit assurance. The CAE reports functionally to the Interim Audit Forum and administratively through the CEO; third-line independence is non-negotiable.
...
2. **Pre-licence readiness gate:** Co-owned by Saskia, Devon, Rashida. Gate conditions: full policy/procedure/system-capability chain complete; ICAAP/ILAAP framework complete; capital raised and in custody; minimum human layer constituted; legal opinions on netting enforceability obtained (Imani + external counsel).
...
The bank's compliance model is **proactive and technology-led**: obligations are encoded as typed artefacts in the substrate; Mira (Compliance/RegTech engineer) maintains the obligations register; Zara (CCO) owns the regulatory relationship. Compliance monitoring is autonomous via continuous recon pipelines (Vera + Mira), not periodic manual review.

Key postures:
- **AML/CFT:** Full KYC substrate live; institutional-counterparty EDD; no high-risk-jurisdiction or PEP onboarding without enhanced review; STR/CTR/TPR filing by autonomous agent under Zara oversight.
- **FAIS:** Fit-and-proper policy live; conflict-of-interest policy live; TCF policy live; no retail advisory.
- **Excon:** FX compliance per SARB Exchange Control Regulations; Rashida authored the Excon compliance assessment.
...
The bank's primary current cost is **Anthropic API token spend** — the largest real cash outlay in the build phase, billed monthly. Marc's time is the binding human resource. Engineering substrate is real work; the cost is compute and API usage.
...
|---|---|---|
| Pre-licence readiness gate | To be confirmed at BRC Cycle 1 (2026-08-04) | Saskia · Devon · Rashida |
| Licence application submission | After readiness gate | Marc (CEO) · Imani · Owen |
| SARB licence grant | Regulator-determined | PA |
| Licence-day operations | After licence grant | All agents |
| First annual ICAAP/ILAAP | Q3 2027 | Helena · Camille |
| Board constitution (full NEDs) | At or before licence-day | Nolan · Owen |
...
|---|---|---|
| Licence risk | PA may require modifications to governance structure, human headcount, or capital | Proactive PA engagement at pre-application stage; Owen leading governance framework |
...
| Capital-raising risk | R300m target may be difficult to raise in current market conditions | Capital plan is Marc's direct responsibility; early engagement with institutional investors post-readiness-gate |
| Technology dependency | Single AI model provider (Anthropic) creates vendor concentration risk | Sade (AgentOps) monitoring token efficiency; architecture is model-agnostic at the agent-interface level; migration path documented |
...
| Talent risk (statutory humans) | Finding the minimum legal minimum of humans willing to serve as directors/officers of an AI-operated bank | Build-phase recruitment planning under Nolan; governance framework documents the limited scope of human decision-making required |
...
**Recommendation:** The CSO function is a licence-day-plus role. During the build phase, strategy is CEO-owned with Chief of Staff synthesis. PAX to define the CSO role spec at the appropriate point in the post-licence roadmap.

**Action:** Owen to register this substrate gap in the governance framework. No immediate hire required.
...
|---|---|---|---|
| v1 DRAFT | 2026-05-22 | Scrooge (Chief of Staff, orchestration) | Initial draft — synthesis of governance-seat inputs; submitted for CEO review and approval |

**Approval required from:** Marc (CEO)  
...
**Approval action:** Scrooge records the decision, updates this document to `status: APPROVED`, and dispatches Owen (Company Secretary) to register the strategy document in the governance framework register.
