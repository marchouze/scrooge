...
asOf: 2026-05-11T05:51:51.102Z
decision-required: false
---

# Imani — Legal-readiness snapshot, 2026-05-11
...
**Headline:** 36 Imani-owned obligations on the register (13 IN FORCE; 1 IN FLIGHT; 2 PARTIAL; 17 PLANNED) · 0 master agreements signed (last 7d) · clause-library version-published: **no — substrate gap** · legal-entity tree count: 1.
...
| Prior `LegalReadinessSnapshot` runs (last 30d) | 0 |
