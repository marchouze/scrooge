...
**Quantitative:** The lifetime probability of default (PD) at the reporting date is significantly higher than the PD at initial recognition. The threshold is a relative 100% increase in the lifetime PD (or an absolute increase of [X] basis points per the approved RAS parameter) — specific parameters approved by Helena (CRO, governance) and Camille (CFO, governance) in the ICAAP.
...
- **Quantitative threshold:** items ≥ [X]% of profit before tax or ≥ [Y]% of total assets (thresholds set annually by Camille (CFO, governance) and documented in the close-cycle working papers).
