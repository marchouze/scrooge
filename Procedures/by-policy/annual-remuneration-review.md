...
|---|---|---|---|---|
| 1 | Receive `AnnualRemunerationReviewInitiated` event; open the review file for the financial year; notify Helena (Chief Risk Officer) and Sade | `system` | `@platform/hr/remuneration-review` (PLANNED) | Review file is the structured workspace for the cycle; all artefacts attach to it. |
