...
| v0.2 | 2026-05-20 | Owen (Company Secretary, governance) | CCO seat reconciliation — references previously attributing Rashida as Chief Compliance Officer were replaced with Zara (Chief Compliance Officer, governance) per `Team/_team-roster.json` canonical roster. Rashida holds the CISO seat; CCO authority for the NPA / commencement-of-trading regulatory-notification pathway is Zara. No substantive procedure change. |
