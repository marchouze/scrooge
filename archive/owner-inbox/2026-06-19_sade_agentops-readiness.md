...
asOf: 2026-06-19T07:41:42.579Z
decision-required: false
---

# Sade — AgentOps readiness snapshot, 2026-06-19
...
**Headline:** 31 agents registered (latest 2026-06-13T18:08:50.183Z) · 0 Sade-owned obligations on the register (0 IN FORCE; 0 PARTIAL; 0 PLANNED) · 8 AgentRegistered + 0 AgentRetired in the last 7 days.
...
| Latest `AgentRegistered` event | 2026-06-13T18:08:50.183Z |
...
| `AgentRegistered` | 8 |
| `AgentRetired` | 0 |
| `IdentityKeyRotated` | 31 |
| `PermissionPolicyPublished` | 94 |
...
_Narrative generation failed (auth failed (check ANTHROPIC_API_KEY): 401 {"type":"error","error":{"type":"authentication_error","message":"invalid x-api-key"},"request_id":"req_011CcCExzqezTrcoXozWZ2Q5"})._
