...
//
// Types extracted to ./dcam/types.ts to break barrel ↔ layer1-conceptual /
// activities / risk circular imports (Vera Wave-4 F-034).
// Re-exported here so existing consumers need no import-path change.
// ---------------------------------------------------------------------------
...
import type { DcamAlignment } from "./dcam/types";
